import{x as n}from"./iframe-Fb9J7T0F.js";import{E as t,M as f}from"./media-DqsfGprR.js";import{I as C}from"./icon-button-DPJu-o0t.js";import{t as g,I as v,s as b,o as y}from"./define-element-tANtzLHx.js";import"./preload-helper-DF6SDP3f.js";import"./unsafe-html-CBF-rTfq.js";import"./directive-DoeGSK_T.js";import"./chevron-down-Bqt06uWP.js";import"./play-6eLew0w_.js";import"./chevron-right-CnbUzkxe.js";import"./arrow-right-Do-kvyXB.js";const I=({width:e=24,height:a=24,hidden:r=!1,title:i="More"}={})=>g`<svg
  ...
  </svg>`;class _ extends v{render(){return b(n),this.spectrumVersion===2?I({hidden:!this.label,title:this.label}):T({hidden:!this.label,title:this.label})}}y("sp-icon-more",_);const E=({width:e=24,height:a=24,hidden:r=!1,title:i="Chevron Right"}={})=>g`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${e}"
    height="${a}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`,D=({width:e=24,height:a=24,hidden:r=!1,title:i="Chevron Right"}={})=>g`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${a}"
    viewBox="0 0 36 36"
    width="${e}"
  ...
  >
    ...
    />
  </svg>`;class $ extends v{render(){return b(n),this.spectrumVersion===2?E({hidden:!this.label,title:this.label}):D({hidden:!this.label,title:this.label})}}y("sp-icon-chevron-right",$);const{fn:S}=__STORYBOOK_MODULE_TEST__,s="https://www.adobe.com/upp",w=`${s}/media_1badc9f153c69f16292c23f9752012c9ab7edb851.mp4`,x=`${s}/media_159d163e5e983109aed71b1cb4e1048b4f849ab72.mp4`,A=`${s}/media_1928dd1a3e8e5ed6e7979b5bb37fcd4c273746e62.mp4`,V=`${s}/media_14d261ad034b647cf9ec9e77e1a4e53cbbd31af35.mp4`,M=`${s}/media_11ef0b05657078d2235cbedc8322cd486a4d83a86.mp4`,o=e=>f({src:e,type:"video",aspectRatio:"3:4",autoplay:!0,muted:!0,loop:!0,playsinline:!0,overlay:void 0}),R="https://www.figma.com/api/mcp/asset/10228c1c-8d4f-42dc-93df-6ed860f219d1",k=n`<sp-icon-more aria-hidden="true" style="width:16px;height:16px"></sp-icon-more>`,O=(e="expanded")=>C({ariaLabel:"Open router context",icon:k,size:"md",context:e==="resting"?"on-light":"on-dark"}),W={title:"Molecules/ElasticCard",tags:["autodocs"],render:e=>t(e),parameters:{docs:{description:{component:'<p>Media-forward tile used in Router hero carousels. Mirrors matt-atoms component set (<a href="https://www.figma.com/design/svi0B0G925V2XG0yX0DDaz/matt-atoms?node-id=4006-461133" target="_blank" rel="noreferrer">node 4006-461133</a>).</p>'},source:{language:"html",code:`<!-- Resting state (default — all cards rest until hovered) -->
...
<article class="c-elastic-card" data-state="expanded" data-media-aspect="3:4">
  …
    ...
    <div style="overflow:hidden; padding-block:24px; background:#f5f5f5; border-radius:24px; width:100%">
      <div style="display:flex; gap:8px; align-items:stretch; justify-content:center;">
        ${t({state:"resting",mediaTemplate:o(w)})}
        ${t({state:"expanded",mediaTemplate:o(x)})}
        ${t({state:"resting",mediaTemplate:o(A)})}
        ${t({state:"resting",mediaTemplate:o(V)})}
        ${t({state:"resting",mediaTemplate:o(M)})}
      </div>
    </div>
  ...
  \`
}`,...h.parameters?.docs?.source}}};const Y=["Resting","Expanded","Mobile","WithActionButton","CustomMediaSlot","OverlayScrim","RoutingCarousel"];export{m as CustomMediaSlot,c as Expanded,l as Mobile,u as OverlayScrim,d as Resting,h as RoutingCarousel,p as WithActionButton,Y as __namedExportsOrder,W as default};
