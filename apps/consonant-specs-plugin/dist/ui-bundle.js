...
(() => {
  ...
  // apps/consonant-specs-plugin/src/ui.ts
  function esc(s) {
  ...
  var _a7;
  (_a7 = document.getElementById("matchBtn")) == null ? void 0 : _a7.addEventListener("click", () => {
    const categories = [];
  ...
  var _a8;
  (_a8 = document.getElementById("fullSpecsBtn")) == null ? void 0 : _a8.addEventListener("click", () => {
    postToPlugin("spec-it", { sections: ["anatomy", "layout", "typography", "components"] });
    updateSpecStatus("Generating full specs...");
  });
  var _a9;
  (_a9 = document.getElementById("specItBtn")) == null ? void 0 : _a9.addEventListener("click", () => {
  ...
  var _a10;
  (_a10 = document.getElementById("localizeBtn")) == null ? void 0 : _a10.addEventListener("click", () => {
    const languages = [];
  ...
  var _a11;
  (_a11 = document.getElementById("saveKeyBtn")) == null ? void 0 : _a11.addEventListener("click", () => {
  ...
  var _a12;
  (_a12 = document.getElementById("clearKeyBtn")) == null ? void 0 : _a12.addEventListener("click", () => {
    const provider = (providerSelect == null ? void 0 : providerSelect.value) || "";
  ...
  function showAiFillInstruction(mode, sections, frameName) {
    ...
    if (el) {
      ...
      (_a21 = document.getElementById("copyFillCmd")) == null ? void 0 : _a21.addEventListener("click", () => {
  ...
  var _a13;
  (_a13 = document.getElementById("a11yCheckAll")) == null ? void 0 : _a13.addEventListener("click", () => {
  ...
  var _a14;
  (_a14 = document.getElementById("a11ySimplified")) == null ? void 0 : _a14.addEventListener("change", () => {
    const simplified = document.getElementById("a11ySimplified");
  ...
  var _a15;
  (_a15 = document.getElementById("a11yAutoRotation")) == null ? void 0 : _a15.addEventListener("change", () => {
    const simplified = document.getElementById("a11ySimplified");
    const regular = document.getElementById("a11yAutoRotation");
  ...
  NOTE_IDS.forEach((id) => {
    var _a21;
    (_a21 = document.getElementById(id)) == null ? void 0 : _a21.addEventListener("change", () => {
      const cb = document.getElementById(id);
      const simplified = document.getElementById("a11ySimplified");
      const regular = document.getElementById("a11yAutoRotation");
  ...
  var _a16;
  (_a16 = document.getElementById("a11yNotesToggle")) == null ? void 0 : _a16.addEventListener("click", () => {
  ...
  var _a17;
  (_a17 = document.getElementById("generateBluelineBtn")) == null ? void 0 : _a17.addEventListener("click", () => {
    var _a21, _b, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o, _p, _q;
    const tier1 = [];
    const tier2 = [];
    if ((_a21 = document.getElementById("a11yFocusIndicators")) == null ? void 0 : _a21.checked) tier1.push("focusIndicators");
  ...
  var _a18;
  (_a18 = document.getElementById("generateBluelinePanelsBtn")) == null ? void 0 : _a18.addEventListener("click", () => {
