import{E as s,x as d,B as f}from"./iframe-BMns1WXj.js";import{e as x,i as C}from"./directive-DoeGSK_T.js";import{C as I,I as _,a as S}from"./icons-C0eZgVe5.js";import"./preload-helper-C1LPWHGs.js";class k extends C{update(o,[e]){const a=o.element;return e?a.play?.().catch?.(()=>{}):a.pause?.(),s}render(){return s}}const A=x(k),h=({imageSrc:n,imageAlt:o="",videoSrc:e,headline:a="",body:r="",showControl:i=!0,playing:t=!0,onControlClick:b}={})=>d`
