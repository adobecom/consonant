...
export default {
  ...
  parameters: {
    docs: {
      description: {
        component: `<p>Primary action button. Matches Figma <code>.Button/Core/Primary</code> node <code>141:53460</code>. Source: <code>packages/components/src/button/button.css</code>.</p>`,
      },
      source: {
        language: "html",
