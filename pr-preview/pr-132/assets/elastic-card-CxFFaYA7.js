import{E as a,x as t}from"./iframe-DReoqYbu.js";import{o as N}from"./unsafe-html-DgchQatj.js";import{P as Z}from"./product-lockup-BtJL_J5h.js";import{c as q}from"./chevron-right-CnbUzkxe.js";import{a as B}from"./arrow-right-Do-kvyXB.js";const G=new Set(["16:9","4:3","1:1","3:2","3:4","21:9"]),H=new Set(["xs","sm","md","lg","xl","full"]),J=new Set(["cover","contain","fill","none","scale-down"]),K=new Set(["center","top","bottom","left","right","top-left","top-right","bottom-left","bottom-right"]),y=(e,i,c)=>i.has(e)?e:c,Q=({src:e,alt:i,lazy:c,decoding:r="async",objectPosition:s})=>t`
  <img
    src=${e??""}
    alt=${i??""}
