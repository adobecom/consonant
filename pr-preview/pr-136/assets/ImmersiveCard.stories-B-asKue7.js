import{E as s,x as d,B as f}from"./iframe-DGf3QGPt.js";import{e as x,i as C}from"./directive-DoeGSK_T.js";import{C as I,I as _,a as S}from"./icons-CP3C4P-s.js";import"./preload-helper-DCUR1HYs.js";class k extends C{update(o,[e]){const a=o.element;return e?a.play?.().catch?.(()=>{}):a.pause?.(),s}render(){return s}}const A=x(k),h=({imageSrc:n,imageAlt:o="",videoSrc:e,headline:a="",body:r="",showControl:i=!0,playing:t=!0,onControlClick:b}={})=>d`
