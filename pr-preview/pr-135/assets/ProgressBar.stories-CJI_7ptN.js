import{x as d}from"./iframe-Cu0bMW1j.js";import"./preload-helper-BZk2PG9u.js";const l=r=>{const a=Number.parseInt(r,10);return Number.isNaN(a)?0:Math.min(100,Math.max(0,a))},s=({progress:r=0}={})=>{const a=l(r);return d`
