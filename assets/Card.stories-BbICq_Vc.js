import{E as C,x as a}from"./iframe-Dfdwu7sf.js";import{P as y,p as _}from"./progress-bar-CsfPWyeb.js";import{A as S}from"./app-icon-C2jtOaoF.js";import"./preload-helper-BSds_FOV.js";const o=({label:n="Card label",body:e,tone:t="knockout",orientation:k="horizontal",active:w=!1,showProgress:P=!1,progress:$=0,onClick:I}={})=>{const m=!!P,x=t==="default"?"default":"knockout";return a`
    <button
      class="c-card"
      data-tone=${x}
