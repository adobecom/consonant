import{x as a}from"./iframe-4mh2bniu.js";import{B as r}from"./button-BgMrin-j.js";import{t as s,I as x,s as y,o as w}from"./define-element-DWMiPB9H.js";import"./preload-helper-CNbBIZ5g.js";const z=({width:t=24,height:e=24,hidden:n=!1,title:o="Download"}={})=>s`<svg
  ...
  ></sp-icon-folder>`,O=()=>a`<sp-icon-chevron-down
    aria-hidden="true"
    style="${k}"
  ></sp-icon-chevron-down>`,j={title:"Components/Button",tags:["autodocs"],render:t=>r(t),parameters:{docs:{description:{component:`
<style>
.doc-pattern {
...
}`,...f.parameters?.docs?.source}}};const K=["Solid","Outlined","Transparent","Disabled","Accent","Sizes","ContextGrid","IconSlots","ForcedStates","BackdropBlur","PrimaryMatrix"];export{p as Accent,m as BackdropBlur,g as ContextGrid,c as Disabled,h as ForcedStates,b as IconSlots,i as Outlined,f as PrimaryMatrix,u as Sizes,l as Solid,d as Transparent,K as __namedExportsOrder,j as default};
