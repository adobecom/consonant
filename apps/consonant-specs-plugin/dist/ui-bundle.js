...
(() => {
  ...
  window.addEventListener("message", (event) => {
    ...
    switch (msg.type) {
      ...
      case "s2a-align-result":
        ...
        break;
      case "match-result":
        updateMatchStatus(msg.message, msg.issues);
        break;
      case "grid-result":
  ...
  function updateMatchStatus(message, issues) {
    const el = document.getElementById("matchStatus");
    if (!el) return;
    let html = `<span style="color:var(--text-secondary)">${esc(message)}</span>`;
    if (issues && issues.length > 0) {
      html += `<div style="margin-top:8px;padding:8px;background:var(--bg-secondary,#f5f5f5);border-radius:6px;border-left:3px solid #ea580c;max-height:200px;overflow-y:auto;">`;
      html += `<div style="font-weight:600;font-size:11px;color:#ea580c;margin-bottom:6px;">${issues.length} approximate match${issues.length > 1 ? "es" : ""} (not exact 1:1)</div>`;
      for (const issue of issues) {
        html += `<div style="font-size:10px;color:var(--text-secondary);padding:3px 0;border-bottom:1px solid var(--border,#e5e5e5);">`;
        html += `<span style="font-weight:600;">${esc(issue.nodeName)}</span> \xB7 ${esc(issue.property)}<br>`;
        html += `<span style="color:#999;">${esc(issue.before)}</span> \u2192 <span style="color:var(--accent,#1473E6);">${esc(issue.after)}</span>`;
        html += `</div>`;
      }
      html += `</div>`;
    }
  ...
  var _a11;
  (_a11 = document.getElementById("localizeBtn")) == null ? void 0 : _a11.addEventListener("click", () => {
    const languages = [];
  ...
  var _a12;
  (_a12 = document.getElementById("saveKeyBtn")) == null ? void 0 : _a12.addEventListener("click", () => {
  ...
  var _a13;
  (_a13 = document.getElementById("clearKeyBtn")) == null ? void 0 : _a13.addEventListener("click", () => {
    const provider = (providerSelect == null ? void 0 : providerSelect.value) || "";
  ...
  function showAiFillInstruction(mode, sections, frameName) {
    ...
    if (el) {
      ...
      (_a22 = document.getElementById("copyFillCmd")) == null ? void 0 : _a22.addEventListener("click", () => {
  ...
  var _a14;
  (_a14 = document.getElementById("a11yCheckAll")) == null ? void 0 : _a14.addEventListener("click", () => {
  ...
  var _a15;
  (_a15 = document.getElementById("a11ySimplified")) == null ? void 0 : _a15.addEventListener("change", () => {
    const simplified = document.getElementById("a11ySimplified");
  ...
  var _a16;
  (_a16 = document.getElementById("a11yAutoRotation")) == null ? void 0 : _a16.addEventListener("change", () => {
    const simplified = document.getElementById("a11ySimplified");
    const regular = document.getElementById("a11yAutoRotation");
  ...
  NOTE_IDS.forEach((id) => {
    var _a22;
    (_a22 = document.getElementById(id)) == null ? void 0 : _a22.addEventListener("change", () => {
      const cb = document.getElementById(id);
      const simplified = document.getElementById("a11ySimplified");
      const regular = document.getElementById("a11yAutoRotation");
  ...
  var _a17;
  (_a17 = document.getElementById("a11yNotesToggle")) == null ? void 0 : _a17.addEventListener("click", () => {
  ...
  var _a18;
  (_a18 = document.getElementById("generateBluelineBtn")) == null ? void 0 : _a18.addEventListener("click", () => {
    var _a22, _b, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o, _p, _q;
    const tier1 = [];
    const tier2 = [];
    if ((_a22 = document.getElementById("a11yFocusIndicators")) == null ? void 0 : _a22.checked) tier1.push("focusIndicators");
  ...
  var _a19;
  (_a19 = document.getElementById("generateBluelinePanelsBtn")) == null ? void 0 : _a19.addEventListener("click", () => {
