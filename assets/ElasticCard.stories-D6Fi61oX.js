import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{c as t,s as n,t as r}from"./lit-UMo5x0iS.js";import{a as i,i as a,o,r as s,s as c,t as l}from"./define-element-2U0jZcCb.js";import{i as u,n as d,r as f,t as p}from"./elastic-card-CqnW0d26.js";import{t as m}from"./icon-button-zPVaV7eM.js";import{t as ee}from"./IconButton-CEs3IdYd.js";function h(){return(h=e((()=>{d()})))()}function g(){return(g=e((()=>{h()})))()}var _;function v(){return(v=e((()=>{s(),_=({width:e=24,height:t=24,hidden:n=!1,title:r=`More`}={})=>i`<svg
  ...
  </svg>`})))()}var y;function b(){return(b=e((()=>{s(),y=({width:e=24,height:t=24,hidden:n=!1,title:r=`More`}={})=>i`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${e}"
    height="${t}"
    viewBox="0 0 36 36"
  ...
  </svg>`})))()}var x;function S(){return(S=e((()=>{t(),c(),s(),v(),b(),x=class extends o{render(){return a(n),this.spectrumVersion===2?_({hidden:!this.label,title:this.label}):y({hidden:!this.label,title:this.label})}}})))()}function C(){return(C=e((()=>{S(),l(`sp-icon-more`,x)})))()}var w;function T(){return(T=e((()=>{s(),w=({width:e=24,height:t=24,hidden:n=!1,title:r=`Chevron Right`}={})=>i`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${e}"
    height="${t}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`})))()}var E;function D(){return(D=e((()=>{s(),E=({width:e=24,height:t=24,hidden:n=!1,title:r=`Chevron Right`}={})=>i`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${t}"
    viewBox="0 0 36 36"
    width="${e}"
  ...
  >
    ...
    />
  </svg>`})))()}var O;function k(){return(k=e((()=>{t(),c(),s(),T(),D(),O=class extends o{render(){return a(n),this.spectrumVersion===2?w({hidden:!this.label,title:this.label}):E({hidden:!this.label,title:this.label})}}})))()}function A(){return(A=e((()=>{k(),l(`sp-icon-chevron-right`,O)})))()}var j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q;function $(){return($=e((()=>{r(),g(),u(),ee(),C(),A(),{fn:j}=__STORYBOOK_MODULE_TEST__,M=`https://www.adobe.com/upp`,N=`${M}/media_1badc9f153c69f16292c23f9752012c9ab7edb851.mp4`,P=`${M}/media_159d163e5e983109aed71b1cb4e1048b4f849ab72.mp4`,F=`${M}/media_1928dd1a3e8e5ed6e7979b5bb37fcd4c273746e62.mp4`,I=`${M}/media_14d261ad034b647cf9ec9e77e1a4e53cbbd31af35.mp4`,L=`${M}/media_11ef0b05657078d2235cbedc8322cd486a4d83a86.mp4`,R=e=>f({src:e,type:`video`,aspectRatio:`3:4`,autoplay:!0,muted:!0,loop:!0,playsinline:!0,overlay:void 0}),z=`https://www.figma.com/api/mcp/asset/10228c1c-8d4f-42dc-93df-6ed860f219d1`,B=n`<sp-icon-more aria-hidden="true" style="width:16px;height:16px"></sp-icon-more>`,V=(e=`expanded`)=>m({ariaLabel:`Open router context`,icon:B,size:`md`,style:e===`resting`?`solid`:`knockout`}),H={title:`Cards/ElasticCard`,tags:[`autodocs`],render:e=>p(e),parameters:{docs:{description:{component:`<p>Media-forward tile used in Router hero carousels. Mirrors the <strong>ElasticCard — v2</strong> component set (<a href="https://www.figma.com/design/oXIFqtnrYNdTIjqb1sbJau/elastic-card-updates?node-id=11280-224039" target="_blank" rel="noreferrer">node 11280-224039</a>): State × Type axes, inverse-token dark surfaces — no Context axis.</p>`},source:{language:`html`,code:`<!-- Resting state (default — all cards rest until hovered) -->
...
<article class="c-elastic-card" data-state="resting" data-type="featured" data-media-aspect="3:4">
  ...
  …
    ...
    <div style="overflow:hidden; padding-block:24px; background:#f5f5f5; border-radius:24px; width:100%">
      <div style="display:flex; gap:8px; align-items:stretch; justify-content:center;">
        ${p({label:`Creativity and design`,app:`firefly`,title:`Create with the top tools.`,body:`Do it all with industry-leading apps for design, photo, video, and creative AI.`,state:`resting`,mediaTemplate:R(N)})}
        ${p({label:`Content creation`,app:`creative-cloud`,title:`Generate stunning content easily.`,body:`Quickly create and edit images, video, and audio with creative AI.`,state:`expanded`,mediaTemplate:R(P),showCaret:!1})}
        ${p({label:`PDF and productivity`,app:`acrobat-pro`,title:`Do it all in less time.`,body:`Create, edit, and share PDFs. Make edits and create presentations with AI.`,state:`resting`,mediaTemplate:R(F)})}
        ${p({label:`Adobe for Business`,app:`genstudio`,title:`Orchestrate customer experiences.`,body:`Deliver business impact, move faster, and personalize at scale.`,state:`resting`,mediaTemplate:R(I)})}
        ${p({label:`Students and teachers`,app:`creative-cloud`,title:`Students and teachers save big.`,body:`Save a bundle on our biggest bundle of top industry creative tools.`,state:`resting`,mediaTemplate:R(L)})}
      </div>
    </div>
  ...
  \`
}`,...Z.parameters?.docs?.source}}},Q=[`Resting`,`Expanded`,`Mobile`,`Featured`,`FeaturedExpanded`,`WithActionButton`,`CustomMediaSlot`,`OverlayScrim`,`RoutingCarousel`]})))()}$();export{Y as CustomMediaSlot,W as Expanded,K as Featured,q as FeaturedExpanded,G as Mobile,X as OverlayScrim,U as Resting,Z as RoutingCarousel,J as WithActionButton,Q as __namedExportsOrder,H as default};