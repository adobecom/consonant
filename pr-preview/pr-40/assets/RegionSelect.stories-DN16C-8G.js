import{x as i}from"./iframe-BJXp3qu0.js";import"./preload-helper-CJlBoiNK.js";const u={title:"Generated/RegionSelect",tags:["autodocs"],parameters:{layout:"fullscreen"}},r=i`<svg width="3" height="6" viewBox="0 0 3 6" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    ">
      ...
      ">
        ...
        ">
          ...
          <!-- EMEA col 2 -->
          <div style="flex: 1; min-width: 0; display: flex; flex-direction: column;">
            ${a("Europe, Middle East and Africa",!1)}
            ${n("Luxembourg - Deutsch")}
            ${n("Luxembourg - English")}
            ${n("Luxembourg - Français")}
            ${n("Magyarország")}
            ${n("Middle East and North Africa - English")}
            ${n("Nederland")}
            ${n("Nigeria")}
            ${n("Norge")}
            ${n("Polska")}
          ...
          <div style="flex: 1; min-width: 0; display: flex; flex-direction: column;">
            ...
            ${n("Svizzera")}
            ${n("Türkiye")}
            ${n("United Arab Emirates - English")}
            ${n("United Kingdom")}
            ${n("Česká republika")}
            ${n("България")}
            ${n("Россия")}
            ...
            ${n("الشرق الأوسط وشمال أفريقيا - اللغة العربية")}
