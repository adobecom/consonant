import{x as s}from"./iframe-B8J6BJgz.js";import{N as o}from"./nav-card-menu-item-DtxnwHnV.js";import"./preload-helper--q6okauN.js";import"./nav-card-shell-Db3Qv6K-.js";import"./nav-card-button-Dw-fWwy-.js";const r=[{label:"Creative Cloud",href:"#"},{label:"Illustrator",href:"#"},{label:"Photoshop",href:"#"},{label:"Premiere Pro",href:"#"},{label:"After Effects",href:"#"},{label:"Substance 3D",href:"#"}],d={title:"Organisms/NavCard/Menu",tags:["autodocs"],render:t=>s`<div style="padding: 32px; background: #f5f5f5; display: inline-flex;">${o(t)}</div>`,parameters:{docs:{description:{component:"Navigation menu card — title heading, link list, and a bottom CTA."},source:{language:"html",code:`<div class="c-nav-card-menu-item">
