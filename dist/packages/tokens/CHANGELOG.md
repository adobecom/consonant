...
- `--s2a-viewport-vertical-padding-2xs` (was `var(--s2a-spacing-xl)`)
- `--s2a-viewport-vertical-padding-lg` (was `var(--s2a-layout-xl)`)
- `--s2a-viewport-vertical-padding-md` (was `var(--s2a-layout-lg)`)
- `--s2a-viewport-vertical-padding-none` (was `var(--s2a-spacing-none)`)
- `--s2a-viewport-vertical-padding-sm` (was `var(--s2a-layout-sm)`)
- `--s2a-viewport-vertical-padding-xl` (was `var(--s2a-layout-2xl)`)
- `--s2a-viewport-vertical-padding-xs` (was `var(--s2a-spacing-4xl)`)
