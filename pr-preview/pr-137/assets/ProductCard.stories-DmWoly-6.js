import{E as a,x as o}from"./iframe-Jwfh8MPX.js";import{A as x,b as f}from"./app-icon-CC8adVOX.js";import"./preload-helper-BU6q58kX.js";const u=({app:e="creative-cloud",showIcon:b=!0,imageSrc:g,imageAlt:v="",heading:m="",body:h="",onClick:r}={})=>{const c=!!g;return o`
    <div
...
`,$={title:"Cards/ProductCard",tags:["autodocs"],render:e=>P(u(e)),parameters:{layout:"centered",backgrounds:{default:"dark",values:[{name:"dark",value:"#1a1a1a"}]},docs:{description:{component:`
...
**Figma:** [elastic-card-updates — Cards page](https://www.figma.com/design/oXIFqtnrYNdTIjqb1sbJau/elastic-card-updates?node-id=4053-701585)
  ...
  \`
}`,...p.parameters?.docs?.source}}};const k=["Default","WithImage","NoIcon","LongCopy","AllApps","GhostGrid"];export{s as AllApps,t as Default,p as GhostGrid,n as LongCopy,d as NoIcon,i as WithImage,k as __namedExportsOrder,$ as default};
