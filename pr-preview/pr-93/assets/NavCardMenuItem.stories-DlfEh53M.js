import{x as s}from"./iframe-BWWDBXZ8.js";import{N as o}from"./nav-card-menu-item-Btpzp-Nn.js";import"./preload-helper-DTD4fYg_.js";import"./nav-card-shell-VaJlo_Bl.js";import"./nav-card-button-ddbirZ-q.js";const r=[{label:"Creative Cloud",href:"#"},{label:"Illustrator",href:"#"},{label:"Photoshop",href:"#"},{label:"Premiere Pro",href:"#"},{label:"After Effects",href:"#"},{label:"Substance 3D",href:"#"}],d={title:"Organisms/NavCard/Menu",tags:["autodocs"],render:t=>s`<div style="padding: 32px; background: #f5f5f5; display: inline-flex;">${o(t)}</div>`,parameters:{docs:{description:{component:"Navigation menu card — title heading, link list, and a bottom CTA."},source:{language:"html",code:`<div class="c-nav-card-menu-item">
