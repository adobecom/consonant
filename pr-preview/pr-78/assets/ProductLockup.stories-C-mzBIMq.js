import{x as p}from"./iframe-P5dnAbel.js";import{P as g}from"./product-lockup-dtIlT43C.js";import{b as h}from"./app-icon-DEjWxJ86.js";import"./preload-helper-CsbrLMn9.js";import"./unsafe-html-wSZE_gUN.js";import"./chevron-right-CnbUzkxe.js";const y=h.map(e=>e.slug),f=e=>{if(!(e==null||e==="auto"))return e},u=(e,m={})=>{const o={...e,...m},b=f(o.iconSize);return b?o.iconSize=b:delete o.iconSize,g(o)},S={title:"Atoms/ProductLockup",tags:["autodocs"],render:e=>u(e),parameters:{docs:{description:{component:"<p>App icon + label identifier used across RouterMarquee, hero tiles, and feature lists. Icons come from the AppIcon CDN (see <code>docs/component-audit/app-icons.md</code> for slug ↔︎ SVG mapping).</p>"},source:{language:"html",code:`<!-- Horizontal (default) — used in RouterMarquee nav strip and MediaCard -->
...
}`,...d.parameters?.docs?.source}}};const I=["HorizontalLabel","HorizontalEyebrow","HorizontalFill","KnockoutOnDark","VerticalLabel","VerticalEyebrow","LabelOnly","NoCaret","AllVariants"];export{d as AllVariants,r as HorizontalEyebrow,t as HorizontalFill,a as HorizontalLabel,n as KnockoutOnDark,l as LabelOnly,c as NoCaret,i as VerticalEyebrow,s as VerticalLabel,I as __namedExportsOrder,S as default};
