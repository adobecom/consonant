import{x as c}from"./iframe-D7du4RHc.js";import{P as n}from"./product-lockup-DOxmBDF2.js";const p=({label:a="Product",app:o="experience-cloud",orientation:r="block",state:i="default",onClick:s}={})=>{const t=i==="active",e=r==="block";return c`
    <button
