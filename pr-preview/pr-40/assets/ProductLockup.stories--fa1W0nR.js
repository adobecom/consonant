import{x as p}from"./iframe-BJXp3qu0.js";import{P as b}from"./product-lockup-B3zSpI0T.js";import{A as y}from"./app-icon-DH8pjiiI.js";import{p as h}from"./product-lockup-Bc6IBSkQ.js";import"./preload-helper-CJlBoiNK.js";/* empty css                       */const f=y.map(e=>e.slug),x=e=>{if(!(e==null||e==="auto"))return e},u=(e,m={})=>{const o={...e,...m},g=x(o.iconSize);return g?o.iconSize=g:delete o.iconSize,b(o)},I={title:"Components/ProductLockup",tags:["autodocs"],render:e=>u(e),parameters:{docs:{description:{component:`
<style>
.doc-pattern {
...
}`,...d.parameters?.docs?.source}}};const L=["HorizontalLabel","HorizontalEyebrow","HorizontalFill","KnockoutOnDark","VerticalLabel","VerticalEyebrow","LabelOnly","NoCaret","AllVariants"];export{d as AllVariants,t as HorizontalEyebrow,r as HorizontalFill,a as HorizontalLabel,n as KnockoutOnDark,c as LabelOnly,l as NoCaret,i as VerticalEyebrow,s as VerticalLabel,L as __namedExportsOrder,I as default};
