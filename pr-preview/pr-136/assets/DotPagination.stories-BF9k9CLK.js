import{x as s}from"./iframe-DGf3QGPt.js";import"./preload-helper-DCUR1HYs.js";const v=t=>{const e=Number.parseInt(t,10);return Number.isNaN(e)?3:Math.min(5,Math.max(1,e))},i=({count:t=3,activeIndex:e=0,ariaLabel:p="Slide navigation",onSelect:d}={})=>{const u=v(t),l=Math.min(u-1,Math.max(0,Number.parseInt(e,10)||0)),m=Array.from({length:u},(a,g)=>g);return s`
