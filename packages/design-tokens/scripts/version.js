...
console.log(`✅ Updated design-tokens version: ${currentVersion} → ${newVersion}`);
...
console.log(`   2. Commit the version bump: git add package.json packages/design-tokens/package.json`);
