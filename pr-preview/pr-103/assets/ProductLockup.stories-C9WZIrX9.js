import{x as p}from"./iframe-BV8OQpRw.js";import{P as g}from"./product-lockup-XY8FOlQN.js";import{b as h}from"./app-icon-D4Yg8w_j.js";import"./preload-helper-BFoh1Q1y.js";import"./unsafe-html-oCehhEBR.js";import"./directive-DoeGSK_T.js";import"./chevron-right-CnbUzkxe.js";const y=h.map(e=>e.slug),f=e=>{if(!(e==null||e==="auto"))return e},u=(e,m={})=>{const o={...e,...m},b=f(o.iconSize);return b?o.iconSize=b:delete o.iconSize,g(o)},I={title:"Atoms/ProductLockup",tags:["autodocs"],render:e=>u(e),parameters:{docs:{description:{component:"<p>App icon + label identifier used across RouterMarquee, hero tiles, and feature lists. Icons come from the AppIcon CDN (see <code>docs/component-audit/app-icons.md</code> for slug ↔︎ SVG mapping).</p>"},source:{language:"html",code:`<!-- Horizontal (default) — used in RouterMarquee nav strip and MediaCard -->
