...
`})))()}function c(){return(c=e((()=>{s()})))()}var l;function u(){return(u=e((()=>{l=`/consonant/pr-preview/pr-143/assets/elastic-card-genstudio-B4_nyhG4.jpg`})))()}var d,f,p,m,h,g,_;function v(){return(v=e((()=>{r(),c(),a(),u(),d={title:`Molecules/Collapsible`,tags:[`autodocs`],render:e=>o(e),parameters:{layout:`padded`,docs:{description:{component:`
