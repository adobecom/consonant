import{x as t}from"./iframe-DDPRpDqY.js";import{I as g}from"./icon-button-CLtdYjge.js";import"./preload-helper-CJk3PlYL.js";import"./unsafe-html-CgCD4tRd.js";import"./directive-DoeGSK_T.js";import"./play-6eLew0w_.js";import"./chevron-right-CnbUzkxe.js";import"./arrow-right-Do-kvyXB.js";const{fn:b}=__STORYBOOK_MODULE_TEST__,x=a=>a==="active"?"play":a==="disabled"?"cross":"pause",e=(a={})=>g(a),k={title:"Atoms/IconButton",tags:["autodocs"],render:a=>e(a),parameters:{docs:{description:{component:"<p>Icon-only action button. Pass any S2A icon name as the <code>icon</code> prop — icons are sourced from <code>packages/components/src/icons/</code> and rendered as inline SVG with <code>currentColor</code> so they inherit the button's tone automatically.</p>"},source:{language:"html",code:`<!-- Solid / on-light -->
