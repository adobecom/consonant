import{x as n}from"./iframe-qK89JQpR.js";import{E as t,M as b}from"./elastic-card-JY_Z4bYf.js";import{I as x}from"./icon-button-DOslXYtA.js";import{t as g,I as f,s as v,o as y}from"./define-element-C-PPjOl-.js";import"./preload-helper-BSds_FOV.js";import"./unsafe-html-Bg4RWLgP.js";import"./product-lockup-VR1aM6qx.js";import"./app-icon-DDzdieiz.js";import"./chevron-right-CnbUzkxe.js";import"./arrow-right-Do-kvyXB.js";import"./play-wKvwUfiG.js";import"./chevron-down-Bqt06uWP.js";import"./arrow-left-CUfdSSC9.js";const I=({width:e=24,height:a=24,hidden:r=!1,title:i="More"}={})=>g`<svg
  ...
  </svg>`;class _ extends f{render(){return v(n),this.spectrumVersion===2?I({hidden:!this.label,title:this.label}):T({hidden:!this.label,title:this.label})}}y("sp-icon-more",_);const D=({width:e=24,height:a=24,hidden:r=!1,title:i="Chevron Right"}={})=>g`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${e}"
    height="${a}"
    viewBox="0 0 20 20"
...
<article class="c-elastic-card" data-state="expanded" data-media-aspect="3:4">
  ...
  \`
}`,...h.parameters?.docs?.source}}};const K=["Resting","Expanded","Mobile","WithActionButton","CustomMediaSlot","OverlayScrim","RoutingCarousel"];export{m as CustomMediaSlot,l as Expanded,c as Mobile,u as OverlayScrim,d as Resting,h as RoutingCarousel,p as WithActionButton,K as __namedExportsOrder,Y as default};
