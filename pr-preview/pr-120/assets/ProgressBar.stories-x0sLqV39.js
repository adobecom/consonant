import{x as d}from"./iframe-BZTzb1tM.js";import"./preload-helper-aORxa1qE.js";const l=r=>{const a=Number.parseInt(r,10);return Number.isNaN(a)?0:Math.min(100,Math.max(0,a))},s=({progress:r=0}={})=>{const a=l(r);return d`
