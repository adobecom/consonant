import{x as o}from"./iframe-qK89JQpR.js";import{I as x}from"./icon-button-DOslXYtA.js";import"./preload-helper-BSds_FOV.js";import"./unsafe-html-Bg4RWLgP.js";import"./play-wKvwUfiG.js";import"./chevron-down-Bqt06uWP.js";import"./chevron-right-CnbUzkxe.js";import"./arrow-left-CUfdSSC9.js";import"./arrow-right-Do-kvyXB.js";const{fn:f}=__STORYBOOK_MODULE_TEST__,y=e=>e,k=e=>e==="active"?"play":e==="disabled"?"cross":"pause",n=(e={})=>{const a=e.size==="md"?"md":"lg";return x({...e,size:a,icon:y(e.icon)})},P={title:"Atoms/IconButton",tags:["autodocs"],render:e=>n(e),parameters:{docs:{description:{component:"<p>Icon-only action button. Pass any S2A icon name as the <code>icon</code> prop — icons are sourced from <code>packages/components/src/icons/</code> and rendered as inline SVG with <code>currentColor</code> so they inherit the button's tone automatically.</p>"},source:{language:"html",code:`<!-- Solid / on-light -->
...
<button class="c-icon-button" data-background="outlined" data-context="on-dark" data-size="md" type="button" aria-label="Mute">
  ...
  \`
}`,...r.parameters?.docs?.source},description:{story:"Focus ring appears when tabbing to the button.",...r.parameters?.docs?.description}}};const _=["Solid","Outlined","Transparent","Disabled","S2aIcons","Sizes","ContextGrid","ForcedStates","FocusStates"];export{p as ContextGrid,d as Disabled,r as FocusStates,u as ForcedStates,s as Outlined,c as S2aIcons,l as Sizes,t as Solid,i as Transparent,_ as __namedExportsOrder,P as default};
