import{x as s}from"./iframe-BXJKph0-.js";const o=n=>{const r=Number.parseInt(n,10);return Number.isNaN(r)?0:Math.min(100,Math.max(0,r))},e=({progress:n=0,tone:r="knockout"}={})=>{const a=o(n);return s`
