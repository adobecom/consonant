import{E as i,x as n}from"./iframe-D6qohOKV.js";import{L as d}from"./list-C3MK7i_9.js";import"./preload-helper-BSds_FOV.js";const p=({label:o="See what's included:",open:l=!1,content:c=i}={})=>n`
...
`,m="/consonant/assets/elastic-card-genstudio-B4_nyhG4.jpg",b={title:"Molecules/Collapsible",tags:["autodocs"],render:o=>p(o),parameters:{layout:"padded",docs:{description:{component:`
...
</details>`}}},argTypes:{label:{control:"text",description:"Trigger label text"},open:{control:"boolean",description:"Whether the content starts expanded"},content:{table:{disable:!0}}},args:{label:"See what's included:",open:!1}},r=n`
  ${d({sections:[{title:"Creative apps",divider:!1,items:["Photoshop","Illustrator","Premiere Pro"]}]})}
`,e={args:{open:!1,content:r}},a={args:{open:!0,content:r}},s={args:{label:"Compare plan features:",open:!0,content:r}},t={name:"With media content",args:{label:"See it in action:",open:!0,content:n`
      <img
        src=${m}
