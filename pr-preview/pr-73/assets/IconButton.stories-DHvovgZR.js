import{x as t}from"./iframe-BtQzUMKu.js";import{I as g}from"./icon-button-QFXM8dNe.js";import"./preload-helper-Gyioare3.js";import"./unsafe-html-BlmzS1IX.js";import"./play-6eLew0w_.js";import"./chevron-right-CnbUzkxe.js";import"./arrow-right-Do-kvyXB.js";const{fn:b}=__STORYBOOK_MODULE_TEST__,x=a=>a==="active"?"play":a==="disabled"?"cross":"pause",e=(a={})=>g(a),w={title:"Atoms/IconButton",tags:["autodocs"],render:a=>e(a),parameters:{docs:{description:{component:"<p>Icon-only action button. Pass any S2A icon name as the <code>icon</code> prop — icons are sourced from <code>packages/components/src/icons/</code> and rendered as inline SVG with <code>currentColor</code> so they inherit the button's tone automatically.</p>"},source:{language:"html",code:`<!-- Solid / on-light -->
...
<button class="c-icon-button" data-style="transparent" data-context="on-light" data-size="sm" type="button" aria-label="Close">
  ...
  \`
}`,...s.parameters?.docs?.source},description:{story:"Focus ring appears when tabbing to the button.",...s.parameters?.docs?.description}}};const k=["Solid","Transparent","Disabled","S2aIcons","Sizes","ContextGrid","ForcedStates","FocusStates"];export{d as ContextGrid,i as Disabled,s as FocusStates,p as ForcedStates,l as S2aIcons,c as Sizes,o as Solid,r as Transparent,k as __namedExportsOrder,w as default};
