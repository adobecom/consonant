import{x as d}from"./iframe-DDgLX23t.js";import"./preload-helper-BSds_FOV.js";const l=r=>{const a=Number.parseInt(r,10);return Number.isNaN(a)?0:Math.min(100,Math.max(0,a))},s=({progress:r=0}={})=>{const a=l(r);return d`
