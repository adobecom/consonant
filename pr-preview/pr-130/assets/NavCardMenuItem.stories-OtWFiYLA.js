import{x as s}from"./iframe-BMns1WXj.js";import{N as o}from"./nav-card-menu-item-B2QCNvPT.js";import"./preload-helper-C1LPWHGs.js";import"./nav-card-shell-DBrvjIHF.js";import"./nav-card-button-BAkJM-2e.js";const r=[{label:"Creative Cloud",href:"#"},{label:"Illustrator",href:"#"},{label:"Photoshop",href:"#"},{label:"Premiere Pro",href:"#"},{label:"After Effects",href:"#"},{label:"Substance 3D",href:"#"}],d={title:"Organisms/NavCard/Menu",tags:["autodocs"],render:t=>s`<div style="padding: 32px; background: #f5f5f5; display: inline-flex;">${o(t)}</div>`,parameters:{docs:{description:{component:"Navigation menu card — title heading, link list, and a bottom CTA."},source:{language:"html",code:`<div class="c-nav-card-menu-item">
