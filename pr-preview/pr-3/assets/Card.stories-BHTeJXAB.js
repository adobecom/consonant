import{E as C,x as a}from"./iframe-C0_fzd1M.js";import{P as y,p as _}from"./progress-bar-CI1uPnTe.js";import{A as S}from"./app-icon-DDMG-7mQ.js";import"./preload-helper-CYBp_IHt.js";const o=({label:n="Card label",body:e,tone:t="knockout",orientation:k="horizontal",active:w=!1,showProgress:P=!1,progress:$=0,onClick:I}={})=>{const m=!!P,x=t==="default"?"default":"knockout";return a`
    <button
      class="c-card"
      data-tone=${x}
