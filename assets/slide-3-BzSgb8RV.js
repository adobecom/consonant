import{E as t,x as a}from"./iframe-D6qohOKV.js";import{c as u}from"./button-Cebqltt4.js";const _=({quote:s="",attributionName:e="",attributionRole:o="",ctaLabel:c="",ctaHref:d="#",showAttribution:r=!0,showCta:l=!0,imageSrc:n="",imageAlt:p=""}={})=>{const i=s.startsWith("“")||s.startsWith('"')?s[0]:"",v=i?s.slice(1):s;return a`
    ...
    <div class="qc-content">
      ...
      ${l&&c?a`
            <div class="qc-actions">
              ${u({label:c,href:d,style:"knockout"})}
            </div>
          `:t}
    </div>
  </div>
