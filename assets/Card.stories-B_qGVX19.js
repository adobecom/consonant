import{E as C,x as a}from"./iframe-ByRN1grG.js";import{P as y,p as _}from"./progress-bar-CJoW_c0X.js";import{A as S}from"./app-icon-fSDPU8Y2.js";import"./preload-helper-BSds_FOV.js";const o=({label:n="Card label",body:e,tone:t="knockout",orientation:k="horizontal",active:w=!1,showProgress:P=!1,progress:$=0,onClick:I}={})=>{const m=!!P,x=t==="default"?"default":"knockout";return a`
    <button
      class="c-card"
      data-tone=${x}
