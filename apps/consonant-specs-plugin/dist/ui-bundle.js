...
(() => {
  ...
  function getSkipSizing() {
    var _a25, _b;
    return (_b = (_a25 = document.getElementById("skipSizingCheck")) == null ? void 0 : _a25.checked) != null ? _b : false;
  }
  var _a;
  (_a = document.getElementById("s2aAuditBtn")) == null ? void 0 : _a.addEventListener("click", () => postToPlugin("s2a-audit"));
  var _a2;
  (_a2 = document.getElementById("fullAlignBtn")) == null ? void 0 : _a2.addEventListener("click", () => postToPlugin("full-align-s2a", { skipSizing: getSkipSizing() }));
  var _a3;
  (_a3 = document.getElementById("textColorsAlignBtn")) == null ? void 0 : _a3.addEventListener("click", () => postToPlugin("text-colors-align", { skipSizing: getSkipSizing() }));
  var _a4;
  (_a4 = document.getElementById("spacingAlignBtn")) == null ? void 0 : _a4.addEventListener("click", () => postToPlugin("spacing-align", { skipSizing: getSkipSizing() }));
  var _a5;
  (_a5 = document.getElementById("gridBtn")) == null ? void 0 : _a5.addEventListener("click", () => {
    postToPlugin("apply-grid");
    updateGridStatus("Applying grid...");
  });
  var _a6;
  (_a6 = document.getElementById("gridXlBtn")) == null ? void 0 : _a6.addEventListener("click", () => {
    postToPlugin("apply-grid-xl");
    updateGridStatus("Applying XL grid...");
  });
  var _a7;
  (_a7 = document.getElementById("gridMargin24Btn")) == null ? void 0 : _a7.addEventListener("click", () => {
    postToPlugin("apply-grid-margin-24");
    updateGridStatus("Applying 24px margin...");
  });
  var _a8;
  (_a8 = document.getElementById("gridMargin16Btn")) == null ? void 0 : _a8.addEventListener("click", () => {
    postToPlugin("apply-grid-margin-16");
    updateGridStatus("Applying 16px margin...");
  });
  var _a9;
  (_a9 = document.getElementById("clearGridBtn")) == null ? void 0 : _a9.addEventListener("click", () => {
  ...
  var _a10;
  (_a10 = document.getElementById("matchCheckAll")) == null ? void 0 : _a10.addEventListener("click", () => {
  ...
  var _a11;
  (_a11 = document.getElementById("matchBtn")) == null ? void 0 : _a11.addEventListener("click", () => {
    var _a25, _b;
    const categories = [];
    ...
    const matchSkipSizing = (_b = (_a25 = document.getElementById("matchSkipSizingCheck")) == null ? void 0 : _a25.checked) != null ? _b : false;
  ...
  var _a12;
  (_a12 = document.getElementById("fullSpecsBtn")) == null ? void 0 : _a12.addEventListener("click", () => {
    postToPlugin("spec-it", { sections: ["anatomy", "layout", "typography", "components"] });
    updateSpecStatus("Generating full specs...");
  });
  var _a13;
  (_a13 = document.getElementById("specItBtn")) == null ? void 0 : _a13.addEventListener("click", () => {
    var _a25, _b, _c, _d, _e, _f, _g;
    const sections = [];
    if ((_a25 = document.getElementById("specAnatomyAnnotation")) == null ? void 0 : _a25.checked) sections.push("anatomyAnnotation");
    if ((_b = document.getElementById("specAnatomy")) == null ? void 0 : _b.checked) sections.push("anatomy");
    if ((_c = document.getElementById("specCardGaps")) == null ? void 0 : _c.checked) sections.push("cardGaps");
    if ((_d = document.getElementById("specSpacingGeneral")) == null ? void 0 : _d.checked) sections.push("spacingGeneral");
    if ((_e = document.getElementById("specSpacing")) == null ? void 0 : _e.checked) sections.push("spacing");
    if ((_f = document.getElementById("specColors")) == null ? void 0 : _f.checked) sections.push("colors");
    if ((_g = document.getElementById("specTextProps")) == null ? void 0 : _g.checked) sections.push("textProperties");
  ...
  var _a14;
  (_a14 = document.getElementById("clearAnnotationsBtn")) == null ? void 0 : _a14.addEventListener("click", () => {
...
Then call figma_render_blueline with mode: "panels" and all item JSON. The panels have already been scaffolded with cloned designs \u2014 the render call will place native Figma annotations on the clones.`;
  ...
  var _a20;
  (_a20 = document.getElementById("a11yCheckAllNotes")) == null ? void 0 : _a20.addEventListener("click", () => {
    if (!bridgeConnected) return;
  ...
  var _a21;
  (_a21 = document.getElementById("generateBluelineBtn")) == null ? void 0 : _a21.addEventListener("click", () => triggerBlueline());
  ...
  var _a22;
  (_a22 = document.getElementById("generateBluelinePanelsBtn")) == null ? void 0 : _a22.addEventListener("click", () => triggerBluelinePanels());
  ...
  var _a23;
  (_a23 = document.getElementById("bridgeConnectBtn")) == null ? void 0 : _a23.addEventListener("click", () => bridgeConnect());
  var _a24;
  (_a24 = document.getElementById("bridgeDisconnectBtn")) == null ? void 0 : _a24.addEventListener("click", () => bridgeDisconnect());
