import{x as p}from"./iframe-ClqxSWPX.js";import{P as b}from"./product-lockup-C6B0ty0W.js";import{A as y}from"./app-icon-Djz3Jzj1.js";import{p as h}from"./product-lockup-Bc6IBSkQ.js";import"./preload-helper-BSds_FOV.js";/* empty css                       */const f=y.map(e=>e.slug),x=e=>{if(!(e==null||e==="auto"))return e},u=(e,m={})=>{const o={...e,...m},g=x(o.iconSize);return g?o.iconSize=g:delete o.iconSize,b(o)},I={title:"Components/ProductLockup",tags:["autodocs"],render:e=>u(e),parameters:{docs:{description:{component:`
<style>
.doc-pattern {
