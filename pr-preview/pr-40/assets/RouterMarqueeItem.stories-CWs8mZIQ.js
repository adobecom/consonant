import{x as o,E as t}from"./iframe-BJXp3qu0.js";import{P as D}from"./product-lockup-B3zSpI0T.js";import{p as E}from"./product-lockup-Bc6IBSkQ.js";import"./preload-helper-CJlBoiNK.js";import"./app-icon-DH8pjiiI.js";/* empty css                       */const F=e=>{const r=Number.parseInt(e,10);return Number.isNaN(r)?0:Math.min(100,Math.max(0,r))},L=({progress:e=0,tone:r="knockout"}={})=>{const d=F(e);return o`
    <span class="c-progress-bar" data-tone=${r}>
      <span class="c-progress-bar__fill" style="width: ${d}%;"></span>
    </span>
  `},T=e=>e==="horizontal"?"horizontal":"vertical",V=e=>e==="eyebrow"?"eyebrow":"label",B=e=>e==="on-dark"?"on-dark":"on-light",O=e=>e==="hug"?"hug":"fill",W=e=>{const r=Number.parseInt(e,10);return Number.isNaN(r)?0:Math.min(100,Math.max(0,r))},j=(e,r)=>e?"a":r?"button":"div",p=({label:e="PDF and productivity",app:r="acrobat-pro",orientation:d="vertical",styleVariant:h="label",context:y="on-light",width:w="fill",showIconStart:k=!0,showIconEnd:$=!0,iconSize:_="auto",active:u=!1,showProgress:P=!0,progress:q="50",body:I,children:m,href:g,ariaLabel:S,onClick:b}={})=>{const f=T(d),z=V(h),v=B(y),C=O(w),M=W(q),N=I??D({label:e,app:r,orientation:f,styleVariant:z,context:v,width:C,showIconStart:k,showIconEnd:$,iconSize:_}),a=j(g,b),A=!!m,x=!!P,R=o`
    ${N}
    ${A?o`<div class="c-router-marquee-item__children">${m}</div>`:t}
  `;return o`
    <${a}
      class="c-router-marquee-item"
      data-active=${u?"true":"false"}
      data-context=${v}
      data-has-progress=${x?"true":"false"}
      data-display=${f}
      href=${g??t}
      aria-label=${S??t}
      @click=${b}
    ...
    >
      <div class="c-router-marquee-item__body">${R}</div>
      ${x?o`<div class="c-router-marquee-item__progress">
            ${L({progress:M,tone:u?"default":"knockout"})}
          </div>`:t}
    </${a}>
...
`,J=["acrobat-pro","acrobat-pdf","creative-cloud","experience-cloud","express","firefly","photoshop","illustrator","indesign","stock"],re={title:"Components/RouterMarqueeItem",tags:["autodocs"],render:e=>o`
...
${G}
\`\`\`
        `}}},argTypes:{label:{control:"text",description:"Product label text"},app:{control:{type:"select"},options:J,description:"AppIcon slug"},orientation:{control:{type:"select"},options:["vertical","horizontal"],description:"ProductLockup orientation"},styleVariant:{control:{type:"select"},options:["label","eyebrow"],description:"Typography style"},context:{control:{type:"select"},options:["on-light","on-dark"],description:"ProductLockup context"},width:{control:{type:"select"},options:["hug","fill"],description:"ProductLockup width"},showIconStart:{control:"boolean",description:"Toggle leading AppIcon"},showIconEnd:{control:"boolean",description:"Toggle caret"},iconSize:{control:{type:"select"},options:["auto","sm","md","lg","xl"],description:"Icon size override"},active:{control:"boolean",description:"Active/selected state"},showProgress:{control:"boolean",description:"Show the timer/progress bar"},progress:{control:{type:"select"},options:["0","25","50","75","100"],description:"Progress bar step"}},args:{label:"PDF and productivity",app:"acrobat-pro",orientation:"vertical",styleVariant:"label",context:"on-light",width:"fill",showIconStart:!0,showIconEnd:!0,iconSize:"auto",active:!1,showProgress:!0,progress:"50"}},n={},s={args:{active:!0,progress:"100"}},i={render:e=>o`
  ...
  \`
}`,...l.parameters?.docs?.source}}};const oe=["Default","Active","ProgressStates","IntentRow","MobileStack"];export{s as Active,n as Default,c as IntentRow,l as MobileStack,i as ProgressStates,oe as __namedExportsOrder,re as default};
