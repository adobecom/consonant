import{x as d}from"./iframe-Jwfh8MPX.js";import"./preload-helper-BU6q58kX.js";const l=r=>{const a=Number.parseInt(r,10);return Number.isNaN(a)?0:Math.min(100,Math.max(0,a))},s=({progress:r=0}={})=>{const a=l(r);return d`
