import{E as C,x as a}from"./iframe-CTqgDSLo.js";import{P as y,p as _}from"./progress-bar-B-onAmYN.js";import{A as S}from"./app-icon-D9giJrEm.js";import"./preload-helper-Bt-8NU40.js";const o=({label:n="Card label",body:e,tone:t="knockout",orientation:k="horizontal",active:w=!1,showProgress:P=!1,progress:$=0,onClick:I}={})=>{const m=!!P,x=t==="default"?"default":"knockout";return a`
    <button
      class="c-card"
      data-tone=${x}
