import{x as d}from"./iframe-B7nRFUFl.js";import"./preload-helper-BFoh1Q1y.js";const l=r=>{const a=Number.parseInt(r,10);return Number.isNaN(a)?0:Math.min(100,Math.max(0,a))},s=({progress:r=0}={})=>{const a=l(r);return d`
