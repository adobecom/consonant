import{x as p}from"./iframe-Beb_h0aT.js";import{P as g}from"./product-lockup-BVZUVfzD.js";import{b as h}from"./app-icon-BIGUd02x.js";import"./preload-helper-BSds_FOV.js";import"./unsafe-html-BnGQGuqv.js";import"./chevron-right-CnbUzkxe.js";const y=h.map(e=>e.slug),f=e=>{if(!(e==null||e==="auto"))return e},u=(e,m={})=>{const o={...e,...m},b=f(o.iconSize);return b?o.iconSize=b:delete o.iconSize,g(o)},S={title:"Atoms/ProductLockup",tags:["autodocs"],render:e=>u(e),parameters:{docs:{description:{component:"<p>App icon + label identifier used across RouterMarquee, hero tiles, and feature lists. Icons come from the AppIcon CDN (see <code>docs/component-audit/app-icons.md</code> for slug ↔︎ SVG mapping).</p>"},source:{language:"html",code:`<!-- Horizontal (default) — used in RouterMarquee nav strip and MediaCard -->
