import{x as n}from"./iframe-_fPFkiU8.js";import{A as o,a as f,b as u}from"./app-icon-BVeyA_W2.js";import"./preload-helper-BSds_FOV.js";const s=["Cross Cloud","Gen AI","Adobe Express","Document Cloud","Digital Imaging","Digital Video & Audio","Print & Publishing","3D & AR","Experience Cloud","Services & Utilities","Beta"],d=[...u].sort((e,a)=>s.indexOf(e.category)-s.indexOf(a.category)||e.label.localeCompare(a.label)),y=[...f].sort((e,a)=>s.indexOf(e.category)-s.indexOf(a.category)||e.label.localeCompare(a.label)),m=d.map(e=>e.slug),x=new Set(m),b=s.map(e=>({category:e,apps:d.filter(a=>a.category===e)})).filter(e=>e.apps.length>0),C={title:"Atoms/AppIcon",tags:["autodocs"],render:e=>o(e),parameters:{docs:{description:{component:`
...
<span class="c-app-icon" data-size="lg" role="img" aria-label="Adobe Firefly">
  ...
  `},c={render:()=>n`
    <div style="display: grid; gap: 8px;">
      ${y.map(e=>n`
          ...
          >
            ${x.has(e.slug)?o({app:e.slug,size:"md"}):n`<span
  ...
  `,parameters:{docs:{description:{story:"Reference catalog for AppIcon slugs. The Figma column maps back to the published App Icons Library component name when available."}}}},t={render:()=>n`
  ...
  \`
}`,...t.parameters?.docs?.source}}};const z=["CreativeCloud","Firefly","Sizes","AllVariants","LibraryCatalog","AccessibleLabel"];export{t as AccessibleLabel,l as AllVariants,i as CreativeCloud,p as Firefly,c as LibraryCatalog,r as Sizes,z as __namedExportsOrder,C as default};
