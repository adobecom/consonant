...
(() => {
    ...
    dynamicSlot(addresses) {
      ...
      for (let dep of this.dependencies) {
        if (dep == "doc")
          ...
          depSel = true;
        else if ((((_a28 = addresses[dep.id]) !== null && _a28 !== void 0 ? _a28 : 1) & 1) == 0)
  ...
  function mergeTransaction(a, b, sequential) {
    ...
    return {
      changes,
      selection: b.selection ? b.selection.map(mapForB) : (_a28 = a.selection) === null || _a28 === void 0 ? void 0 : _a28.map(mapForA),
  ...
  function moveVisually(line, order, dir, start, forward) {
    ...
    if (start.head == line.from && start.assoc < 0) {
      ...
      spanI = BidiSpan.find(order, startIndex, (_a28 = start.bidiLevel) !== null && _a28 !== void 0 ? _a28 : -1, start.assoc);
    }
  ...
  var PluginInstance = class {
    ...
    destroy(view) {
      var _a28;
      if ((_a28 = this.value) === null || _a28 === void 0 ? void 0 : _a28.destroy) {
        try {
          this.value.destroy();
        } catch (e) {
          logException(view.state, e, "CodeMirror plugin crashed");
  ...
  var CompositeTile = class extends Tile {
    ...
    sync(track) {
      if (this.flags & 2)
        return;
      super.sync(track);
      let parent2 = this.dom, prev = null, next;
      let tracking = (track === null || track === void 0 ? void 0 : track.node) == parent2 ? track : null;
      let length = 0;
      for (let child of this.children) {
        child.sync(track);
  ...
  var LineTile = class _LineTile extends CompositeTile {
    ...
    domIn(pos, side) {
      ...
      if (found) {
        ...
        let parent2 = found.tile.parent, saw = false;
        for (let ch of parent2.children) {
          if (saw)
  ...
  var TileBuilder = class {
    ...
    addText(text, marks2, openStart, tile) {
      var _a28;
      this.flushBuffer();
      let parent2 = this.ensureMarks(marks2, openStart);
      let prev = parent2.lastChild;
      if (prev && prev.isText() && !(prev.flags & 8) && prev.length + text.length < 512) {
        ...
        let tile2 = parent2.children[parent2.children.length - 1] = new TextTile(prev.dom, prev.text + text);
        tile2.parent = parent2;
      } else {
        parent2.append(tile || TextTile.of(text, (_a28 = this.cache.find(TextTile)) === null || _a28 === void 0 ? void 0 : _a28.dom));
      }
    ...
    addInlineWidget(widget, marks2, openStart) {
      ...
      if (!noSpace && !(widget.flags & 16))
        parent2.append(this.getBuffer(1));
    ...
    addLineStart(attrs, dom) {
      ...
      if (!attrs)
        attrs = lineBaseAttrs;
      let tile = LineTile.start(attrs, dom || ((_a28 = this.cache.find(LineTile)) === null || _a28 === void 0 ? void 0 : _a28.dom), !!dom);
    ...
    ensureMarks(marks2, openStart) {
      var _a28;
      let parent2 = this.curLine;
      for (let i2 = marks2.length - 1; i2 >= 0; i2--) {
        let mark = marks2[i2], last2;
        if (openStart > 0 && (last2 = parent2.lastChild) && last2 instanceof MarkTile && last2.mark.eq(mark)) {
          parent2 = last2;
          openStart--;
        } else {
          let tile = MarkTile.of(mark, (_a28 = this.cache.find(MarkTile, (m) => m.mark.eq(mark))) === null || _a28 === void 0 ? void 0 : _a28.dom);
          parent2.append(tile);
          parent2 = tile;
          openStart = 0;
        }
    ...
    getBlockPos() {
      ...
      for (let wrap of this.wrappers) {
        let last2 = parent2.lastChild;
        if (wrap.from < this.pos && last2 instanceof BlockWrapperTile && last2.wrapper.eq(wrap.wrapper)) {
          parent2 = last2;
        } else {
          let tile = BlockWrapperTile.of(wrap.wrapper, (_a28 = this.cache.find(BlockWrapperTile, (t2) => t2.wrapper.eq(wrap.wrapper))) === null || _a28 === void 0 ? void 0 : _a28.dom);
          parent2.append(tile);
          parent2 = tile;
        }
      }
  ...
  var TileUpdate = class {
    ...
    getCompositionContext(text) {
      ...
      for (let parent2 = text.parentNode; ; parent2 = parent2.parentNode) {
        let tile = Tile.get(parent2);
        if (parent2 == this.view.contentDOM)
          break;
        if (tile instanceof MarkTile)
          marks2.push(tile);
        ...
        else if (parent2.nodeName == "DIV" && !line)
          line = new LineTile(parent2, lineBaseAttrs);
        else if (!line)
          marks2.push(MarkTile.of(new MarkDecoration({ tagName: parent2.nodeName.toLowerCase(), attributes: getAttrs(parent2) }), parent2));
      }
      if (!line)
        return null;
  ...
  var DocView = class {
    ...
    update(update) {
      ...
      if (this.view.inputState.composing >= 0 && !this.view.observer.editContext) {
        if ((_a28 = this.domChanged) === null || _a28 === void 0 ? void 0 : _a28.newSel)
  ...
  var DOMReader = class {
    ...
    readRange(start, end) {
      ...
      for (let cur = start; ; ) {
        this.findPointBefore(parent2, cur);
        let oldLen = this.text.length;
        this.readNode(cur);
        let tile = Tile.get(cur), next = cur.nextSibling;
        if (next == end) {
          if ((tile === null || tile === void 0 ? void 0 : tile.breakAfter) && !next && parent2 != this.view.contentDOM)
            this.lineBreak();
          break;
        }
  ...
  handlers.beforeinput = (view, event) => {
    ...
    if (event.inputType == "insertReplacementText" && view.observer.editContext) {
      let text = (_a28 = event.dataTransfer) === null || _a28 === void 0 ? void 0 : _a28.getData("text/plain"), ranges = event.getTargetRanges();
    ...
    if (browser.chrome && browser.android && (pending = PendingKeys.find((key) => key.inputType == event.inputType))) {
      ...
      if (pending.key == "Backspace" || pending.key == "Delete") {
        ...
        setTimeout(() => {
          var _a29;
          if ((((_a29 = window.visualViewport) === null || _a29 === void 0 ? void 0 : _a29.height) || 0) > startViewHeight + 10 && view.hasFocus) {
  ...
  var DOMObserver = class {
    constructor(view) {
      ...
      if (typeof ResizeObserver == "function") {
        this.resizeScroll = new ResizeObserver(() => {
          var _a28;
          if (((_a28 = this.view.docView) === null || _a28 === void 0 ? void 0 : _a28.lastUpdate) < Date.now() - 75)
            this.onResize();
        });
    ...
    delayAndroidKey(key, keyCode) {
      ...
      if (!this.delayedAndroidKey || key == "Enter")
        this.delayedAndroidKey = {
          ...
          force: this.lastChange < Date.now() - 50 || !!((_a28 = this.delayedAndroidKey) === null || _a28 === void 0 ? void 0 : _a28.force)
        };
    }
    ...
    destroy() {
      var _a28, _b, _c;
      this.stop();
      (_a28 = this.intersection) === null || _a28 === void 0 ? void 0 : _a28.disconnect();
  ...
  function findChild(tile, dom, dir) {
    while (dom) {
      ...
      dom = parent2 != tile.dom ? parent2 : dir > 0 ? dom.nextSibling : dom.previousSibling;
    }
    return null;
  }
  ...
  var EditorView = class _EditorView {
    ...
    */
    constructor(config2 = {}) {
      ...
      this.updateState = 0;
      this.requestMeasure();
      if ((_a28 = document.fonts) === null || _a28 === void 0 ? void 0 : _a28.ready)
    ...
    */
    get hasFocus() {
      var _a28;
      return (this.dom.ownerDocument.hasFocus() || browser.safari && ((_a28 = this.inputState) === null || _a28 === void 0 ? void 0 : _a28.lastContextMenu) > Date.now() - 3e4) && this.root.activeElement == this.contentDOM;
    }
    /**
    ...
    */
    static scrollIntoView(pos, options = {}) {
      var _a28, _b, _c, _d;
      return scrollIntoView.of(new ScrollTarget(typeof pos == "number" ? EditorSelection.cursor(pos) : pos, (_a28 = options.y) !== null && _a28 !== void 0 ? _a28 : "nearest", (_b = options.x) !== null && _b !== void 0 ? _b : "nearest", (_c = options.yMargin) !== null && _c !== void 0 ? _c : 5, (_d = options.xMargin) !== null && _d !== void 0 ? _d : 5));
    }
    /**
    ...
    */
    static findFromDOM(dom) {
      ...
      return ((_a28 = tile === null || tile === void 0 ? void 0 : tile.root) === null || _a28 === void 0 ? void 0 : _a28.view) || null;
    }
  };
  ...
  function buildKeymap(bindings, platform = currentPlatform) {
    ...
    let add2 = (scope, key, command2, preventDefault, stopPropagation) => {
      ...
      let binding = scopeObj[full] || (scopeObj[full] = {
        ...
        stopPropagation: false,
        run: ((_b = (_a28 = scopeObj._any) === null || _a28 === void 0 ? void 0 : _a28.run) === null || _b === void 0 ? void 0 : _b.slice()) || []
      });
      if (command2)
  ...
  function supportsTabSize() {
    ...
    if (_supportsTabSize == null && typeof document != "undefined" && document.body) {
      ...
      _supportsTabSize = ((_a28 = styles.tabSize) !== null && _a28 !== void 0 ? _a28 : styles.MozTabSize) != null;
    }
  ...
  function crosshairCursor(options = {}) {
    ...
    return [
      ...
      EditorView.contentAttributes.of((view) => {
        var _a28;
        return ((_a28 = view.plugin(plugin)) === null || _a28 === void 0 ? void 0 : _a28.isDown) ? showCrosshair : null;
      })
    ];
  }
  var Outside = "-10000px";
    ...
    update(update, above) {
      ...
      for (let t2 of this.tooltipViews)
        if (tooltipViews.indexOf(t2) < 0) {
          ...
          (_a28 = t2.destroy) === null || _a28 === void 0 ? void 0 : _a28.call(t2);
        }
      if (above) {
  ...
  var tooltipConfig = /* @__PURE__ */ Facet.define({
    combine: (values) => {
      var _a28, _b, _c;
      return {
        position: browser.ios ? "absolute" : ((_a28 = values.find((conf) => conf.position)) === null || _a28 === void 0 ? void 0 : _a28.position) || "fixed",
  ...
  var tooltipPlugin = /* @__PURE__ */ ViewPlugin.fromClass(class {
    ...
    destroy() {
      ...
      for (let tooltipView of this.manager.tooltipViews) {
        ...
        (_a28 = tooltipView.destroy) === null || _a28 === void 0 ? void 0 : _a28.call(tooltipView);
      }
      if (this.parent)
        this.container.remove();
    ...
    writeMeasure(measured) {
      ...
      for (let i2 = 0; i2 < this.manager.tooltips.length; i2++) {
        ...
        let width = size.right - size.left, height = (_a28 = knownHeight.get(tView)) !== null && _a28 !== void 0 ? _a28 : size.bottom - size.top;
  ...
  var showHoverTooltipHost = /* @__PURE__ */ showTooltip.compute([showHoverTooltip], (state) => {
    ...
    return {
      pos: Math.min(...tooltips.map((t2) => t2.pos)),
        ...
        var _a28;
        return (_a28 = t2.end) !== null && _a28 !== void 0 ? _a28 : t2.pos;
      })),
  ...
  var HoverPlugin = class {
    ...
    mousemove(event) {
      ...
      if (active.length && !this.locked.has(active) && tooltip && !isInTooltip(tooltip.dom, event) || this.pending) {
        let { pos } = active[0] || this.pending, end = (_b = (_a28 = active[0]) === null || _a28 === void 0 ? void 0 : _a28.end) !== null && _b !== void 0 ? _b : pos;
  ...
  function resolveNode(node, pos, side, overlays) {
    ...
    if (overlays)
      for (let scan = node, parent2 = scan.parent; parent2; scan = parent2, parent2 = scan.parent) {
        if (scan instanceof TreeNode && scan.index < 0 && ((_a28 = parent2.enter(pos, side, mode)) === null || _a28 === void 0 ? void 0 : _a28.from) != scan.from)
          node = parent2;
      }
    for (; ; ) {
  ...
  var TreeNode = class _TreeNode extends BaseNode {
    ...
    nextChild(i2, dir, pos, side, mode = 0) {
      for (let parent2 = this; ; ) {
        for (let { children, positions } = parent2._tree, e = dir > 0 ? children.length : -1; i2 != e; i2 += dir) {
          let next = children[i2], start = positions[i2] + parent2.from, mounted;
          ...
          if (next instanceof TreeBuffer) {
            ...
            if (index > -1)
              return new BufferNode(new BufferContext(parent2, next, i2, start), null, index);
          } else if (mode & IterMode.IncludeAnonymous || (!next.type.isAnonymous || hasChild(next))) {
            let mounted2;
            if (!(mode & IterMode.IgnoreMounts) && (mounted2 = MountedTree.get(next)) && !mounted2.overlay)
              return new _TreeNode(mounted2.tree, start, i2, parent2);
    ...
    */
    ...
    atLastNode(dir) {
      ...
      for (; parent2; { index, _parent: parent2 } = parent2) {
        if (index > -1)
          for (let i2 = index + dir, e = dir < 0 ? -1 : parent2._tree.children.length; i2 != e; i2 += dir) {
  ...
  function buildTree(data) {
    ...
    let length = (_a28 = data.length) !== null && _a28 !== void 0 ? _a28 : children.length ? positions[0] + children[0].length : 0;
      ...
      return this.withContext(() => {
        ...
        for (; ; ) {
          ...
          if (done) {
            ...
            this.treeLen = (_a28 = this.parse.stoppedAt) !== null && _a28 !== void 0 ? _a28 : this.state.doc.length;
            this.tree = done;
            this.parse = null;
  ...
  var foldState = /* @__PURE__ */ StateField.define({
    ...
    update(folded, tr) {
      ...
      if (rangesToFold.length) {
        let { preparePlaceholder: preparePlaceholder2 } = tr.state.facet(foldConfig);
        let decorations2 = rangesToFold.map((value) => {
          let widget = !preparePlaceholder2 ? foldWidget : Decoration.replace({ widget: new PreparedFoldWidget(preparePlaceholder2(tr.state, value)) });
  ...
  function findFold(state, from, to) {
    var _a28;
    let found = null;
    (_a28 = state.field(foldState, false)) === null || _a28 === void 0 ? void 0 : _a28.between(from, to, (from2, to2) => {
  ...
  function foldGutter(config2 = {}) {
    ...
    return [
      ...
      gutter({
        ...
        markers(view) {
          var _a28;
          return ((_a28 = view.plugin(markers)) === null || _a28 === void 0 ? void 0 : _a28.markers) || RangeSet.empty;
        },
        initialSpacer() {
  ...
  var HistEvent = class _HistEvent {
    ...
    toJSON() {
      var _a28, _b, _c;
      return {
        changes: (_a28 = this.changes) === null || _a28 === void 0 ? void 0 : _a28.toJSON(),
  ...
  function defaultQuery(state, fallback) {
    ...
    return new SearchQuery({
      search: ((_a28 = fallback === null || fallback === void 0 ? void 0 : fallback.literal) !== null && _a28 !== void 0 ? _a28 : config2.literal) ? selText : selText.replace(/\n/g, "\\n"),
  ...
  function renderDiagnostic(view, diagnostic, inPanel) {
    ...
    return crelt("li", { class: "cm-diagnostic cm-diagnostic-" + diagnostic.severity }, crelt("span", { class: "cm-diagnosticText" }, diagnostic.renderMessage ? diagnostic.renderMessage(view) : diagnostic.message), (_a28 = diagnostic.actions) === null || _a28 === void 0 ? void 0 : _a28.map((action, i2) => {
  ...
  var Stack = class _Stack {
    ...
    @internal
    */
    constructor(p, stack, state, reducePos, pos, score, buffer, bufferBase, curContext, lookAhead = 0, parent2) {
      this.p = p;
      this.stack = stack;
      this.state = state;
    ...
    */
    reduce(action) {
      ...
      if (size >= 2e3 && !((_a28 = this.p.parser.nodeSet.types[type]) === null || _a28 === void 0 ? void 0 : _a28.isAnonymous)) {
  ...
  var highlight = HighlightStyle.define([
    { tag: tags.propertyName, color: "#1A1C1E", fontWeight: "600" },
    { tag: tags.string, color: "#1C6B48" },
    { tag: tags.number, color: "#8A4B16" },
    { tag: tags.bool, color: "#4B5CF0" },
    { tag: tags.null, color: "#9AA1AC" },
    { tag: tags.punctuation, color: "#9AA1AC" },
  ...
  var preparePlaceholder = (state, range) => {
  ...
  var foldPlaceholder = (_view, onclick, prepared) => {
    const el2 = document.createElement("span");
    el2.textContent = `\u2026 ${prepared != null ? prepared : ""}`.trim();
    el2.title = "Click to unfold";
  ...
  function createJsonEditor(parent2, opts) {
    const editable2 = new Compartment();
    let external = [];
    const view = new EditorView({
      ...
      state: EditorState.create({
        ...
        extensions: [
          ...
          editable2.of(EditorView.editable.of(true)),
          EditorView.updateListener.of((u) => {
            var _a28, _b;
            if (!u.docChanged) return;
            external = (_b = (_a28 = opts.externalDiagnostics) == null ? void 0 : _a28.call(opts)) != null ? _b : [];
            opts.onChange(u.state.doc.toString());
          })
        ]
      })
    });
    const foldToDepth = (depth) => {
      var _a28, _b;
      unfoldAll(view);
      const effects = [];
      for (let i2 = 1; i2 <= view.state.doc.lines; i2++) {
        const line = view.state.doc.line(i2);
        const indent = (_b = (_a28 = line.text.match(/^\s*/)) == null ? void 0 : _a28[0].length) != null ? _b : 0;
  ...
  function switchPanel(panel) {
    activePanel = panel;
    Object.entries(panelEls).forEach(([key, el2]) => {
      el2.classList.toggle("active", key === panel);
    });
  ...
  var FEATURES = [
    // Tools
    {
      ...
      uiAction: () => {
        var _a28;
        return (_a28 = document.getElementById("copyNodeBtn")) == null ? void 0 : _a28.click();
      }
    },
    {
    ...
    paletteList.querySelectorAll(".palette-row").forEach((row) => {
      ...
      row.addEventListener("mouseenter", () => {
        ...
        paletteList.querySelectorAll(".palette-row").forEach(
          (r, i2) => r.setAttribute("data-selected", String(i2 === paletteSelected))
        );
      });
    });
  }
  ...
  paletteInput.addEventListener("keydown", (e) => {
    ...
    if (e.key === "ArrowDown") {
      ...
      renderPalette();
      (_a28 = paletteList.querySelector(`[data-selected="true"]`)) == null ? void 0 : _a28.scrollIntoView({ block: "nearest" });
  ...
  var _a2;
  (_a2 = document.getElementById("paletteHintBtn")) == null ? void 0 : _a2.addEventListener("click", () => openPalette());
  ...
  function copyToClipboard(text) {
    ...
    try {
      (_a28 = navigator.clipboard) == null ? void 0 : _a28.writeText(text).catch(() => {
      });
    } catch (e) {
    }
  }
  ...
  function setAnnotateStatus(msg, type = "") {
    const el2 = document.getElementById("annotateStatus");
    el2.textContent = msg;
    el2.className = "status" + (type ? " " + type : "");
  }
  function updateAnnotateSelection(sel) {
    var _a28;
    annotateNodeId = (_a28 = sel == null ? void 0 : sel.id) != null ? _a28 : null;
  ...
  function setDocStatus(msg, type = "") {
    const el2 = document.getElementById("docStatus");
    el2.textContent = msg;
    el2.className = "status" + (type ? " " + type : "");
  }
  function updateDocSelection(sel) {
    ...
    docSetId = isDocable ? (_a28 = sel == null ? void 0 : sel.id) != null ? _a28 : null : null;
  ...
  var docCheckId = null;
  function updateDocCheckSelection(sel) {
    var _a28;
    const ok = (sel == null ? void 0 : sel.nodeType) === "FRAME";
    docCheckId = ok ? (_a28 = sel == null ? void 0 : sel.id) != null ? _a28 : null : null;
    const emptyEl = document.getElementById("docCheckSelectionEmpty");
    const infoEl = document.getElementById("docCheckSelectionInfo");
    const nameEl = document.getElementById("docCheckName");
    const metaEl = document.getElementById("docCheckMeta");
    const btn = document.getElementById("docCheckBtn");
    if (ok && sel) {
      emptyEl.style.display = "none";
      infoEl.style.display = "flex";
      nameEl.textContent = sel.name;
      metaEl.textContent = sel.width && sel.height ? `${Math.round(sel.width)} \xD7 ${Math.round(sel.height)}` : "frame";
      btn.disabled = false;
    } else {
      emptyEl.style.display = "block";
      infoEl.style.display = "none";
      btn.disabled = true;
      const issues = document.getElementById("docCheckIssues");
      issues.style.display = "none";
      issues.innerHTML = "";
    }
  }
  var _a8;
  (_a8 = document.getElementById("docCheckBtn")) == null ? void 0 : _a8.addEventListener("click", () => {
    if (!docCheckId) return;
    sendTelemetry("action:docs-check");
    const btn = document.getElementById("docCheckBtn");
    btn.disabled = true;
    btn.textContent = "Checking\u2026";
    const status = document.getElementById("docCheckStatus");
    status.textContent = "";
    postToPlugin("docs:check", { nodeId: docCheckId });
  });
  var _a9;
  (_a9 = document.getElementById("docGenerateBtn")) == null ? void 0 : _a9.addEventListener("click", () => {
    if (!docSetId) return;
  ...
  async function studioRefreshIndex() {
    ...
    try {
      ...
      for (const c of [...rows].sort((a, b) => {
        var _a29, _b;
        return String((_a29 = a.name) != null ? _a29 : a.slug).localeCompare(String((_b = b.name) != null ? _b : b.slug));
      })) {
        const row = document.createElement("button");
        row.className = "studio-row";
        const name2 = document.createElement("span");
        name2.className = "studio-row-name";
        name2.textContent = String((_a28 = c.name) != null ? _a28 : c.slug);
  ...
  async function studioOpen(ref, by = "slug") {
    var _a28, _b, _c, _d, _e, _f, _g, _h, _i;
    studioUnmountEditor();
    studio = __spreadProps(__spreadValues({}, emptyStudio()), { slug: by === "slug" ? ref : null, busy: true });
    studioResult = null;
    studioShow("editor");
    ...
    try {
      ...
      if (!res.ok) {
        const hint = res.status === 404 ? "Sync server is running older code. Restart it: npm run contract-sync (in apps/s2a-toolkit)." : `Sync server returned ${res.status}.`;
        throw new Error(hint);
      }
      const ctx = await res.json();
      studio.slug = (_a28 = ctx.slug) != null ? _a28 : studio.slug;
      studio.def = ctx.def;
      studio.evidence = ctx.evidence;
      studio.freeAxes = (_b = ctx.freeAxes) != null ? _b : [];
      studio.index = (_c = ctx.index) != null ? _c : {};
      studio.busy = false;
      if (!ctx.hasDef) {
        studio.validation = { valid: false, errors: ["no curated definition for this set yet"], warnings: [] };
        studioRender();
        studioRenderEmpty(Boolean((_e = (_d = ctx.evidence) == null ? void 0 : _d.axes) == null ? void 0 : _e.length));
        return;
      }
      studioRender();
      studioValidate();
      if (studioSel && slotsOf((_f = studio.def) != null ? _f : {}).length) postToPlugin("studio:swap-targets", { setId: studioSel.id });
    } catch (err) {
      studio.busy = false;
      studio.validation = { valid: false, errors: [String((_g = err == null ? void 0 : err.message) != null ? _g : err)], warnings: [] };
      $s("studioSub").textContent = (_h = studio.slug) != null ? _h : ref;
      $s("studioGui").innerHTML = "";
      $s("studioGui").appendChild(el("div", "studio-empty", String((_i = err == null ? void 0 : err.message) != null ? _i : err)));
      $s("studioDraftNotes").style.display = "none";
      studioRenderFooter();
    }
  }
  ...
  function studioEdit(fn) {
    studioResult = null;
    studio.def = mutateDef(studio, fn);
    studio.dirty = true;
    studio.validation = null;
    if (studio.jsonMode) studioEditor == null ? void 0 : studioEditor.setValue(JSON.stringify(studio.def, null, 2));
    studioRender();
    studioValidate();
  }
  ...
  function studioRenderFooter() {
    var _a28, _b;
    const v = studioResult != null ? studioResult : verdictOf(studio);
    const node = $s("studioVerdict");
    node.className = `studio-verdict ${v.tone}`;
    node.textContent = v.text;
    const warn = ((_b = (_a28 = studio.validation) == null ? void 0 : _a28.warnings) != null ? _b : []).map((w) => `\u26A0 ${w}`).join("\n");
    $s("studioWarnings").textContent = warn;
    $s("studioWarnings").style.display = warn ? "block" : "none";
    $s("studioPublishBtn").disabled = !canPublish(studio);
  }
  var el = (tag, cls, text) => {
  ...
  function studioSection(title, add2) {
    const sec = el("div", "studio-sec");
    const head = el("div", "studio-sec-head");
    const h = el("div", "section-label", title);
    h.style.margin = "0";
    head.appendChild(h);
    if (add2) head.appendChild(add2);
    sec.appendChild(head);
    return sec;
  }
  function studioAddButton(label, options, onPick) {
    if (!options.length) return void 0;
    const wrap = el("div");
    wrap.style.cssText = "position:relative;";
    const btn = el("button", "studio-add", label);
  ...
  var stripHash = (n) => String(n).split("#")[0].trim();
  var kebabish = (n) => String(n).trim().toLowerCase().replace(/[^a-z0-9]+/g, "-").replace(/^-+|-+$/g, "");
  function studioRenderGui() {
    var _a28, _b, _c, _d, _e, _f, _g, _h;
    ...
    const props = studioSection(
      `Props \xB7 ${((_a28 = d.props) != null ? _a28 : []).length}`,
      studioAddButton(
        "+ from an axis",
        free.map((a) => ({ value: a.name, text: `${a.name} \xB7 ${a.type}` })),
        (name2) => studioEdit((def) => {
          var _a29, _b2, _c2;
          const axis = ((_b2 = (_a29 = studio.evidence) == null ? void 0 : _a29.axes) != null ? _b2 : []).find((a) => a.name === name2);
          if (axis) (def.props = (_c2 = def.props) != null ? _c2 : []).push(propFromAxis(axis));
        })
      )
    );
    for (const [i2, prop] of ((_b = d.props) != null ? _b : []).entries()) {
      const row = el("div", "studio-item");
      row.appendChild(el("span", "studio-item-name", prop.name));
      row.appendChild(el("span", "studio-item-bind", ((_c = prop.figma) == null ? void 0 : _c.property) ? `${prop.figma.kind} \xB7 ${prop.figma.property}` : "no design counterpart"));
      const lever = el("input");
      lever.type = "checkbox";
      lever.checked = Boolean(prop.lever);
      lever.title = "Lever: authored by a designer. Unchecked means integration-only.";
      lever.addEventListener("change", () => studioEdit((def) => {
        def.props[i2].lever = lever.checked;
      }));
      row.appendChild(lever);
      const del = el("button", "studio-del", "\xD7");
      del.title = `Remove ${prop.name}`;
      del.addEventListener("click", () => studioEdit((def) => {
        def.props.splice(i2, 1);
      }));
      row.appendChild(del);
    ...
    const chips = el("div");
    for (const [i2, st] of used.entries()) {
      const c = el("button", "studio-toggle on", st);
      c.title = `Remove ${st}`;
      c.addEventListener("click", () => studioEdit((def) => {
        def.states.splice(i2, 1);
        if (!def.states.length) delete def.states;
      }));
      chips.appendChild(c);
    }
    ...
    if (slots.length) {
      const sec = studioSection(`Slots \xB7 ${slots.length}`);
      for (const { path, node } of slots) {
        ...
        const mode = el("select", "form-input");
        ...
        mode.addEventListener("change", () => studioEdit((def) => {
          const t2 = slotsOf(def).find((x) => x.path === path);
          if (t2) t2.node.slot.acceptsMode = mode.value;
        }));
        ...
        for (const n of names) {
          const on = ((_f = node.slot.accepts) != null ? _f : []).includes(n);
          const b = el("button", `studio-toggle${on ? " on" : ""}`, n);
          b.addEventListener("click", () => studioEdit((def) => {
            var _a29;
            const t2 = slotsOf(def).find((x) => x.path === path);
            if (!t2) return;
            const a = t2.node.slot.accepts = (_a29 = t2.node.slot.accepts) != null ? _a29 : [];
            const at = a.indexOf(n);
        ...
        box.appendChild(acc);
        const swapProp = ((_g = d.props) != null ? _g : []).find((p) => {
          var _a29;
          return ((_a29 = p.figma) == null ? void 0 : _a29.kind) === "INSTANCE_SWAP" && kebabish(stripHash(p.figma.property)) === path.split(".").pop();
        });
        const declared = swapProp ? (_h = studioSwapTargets[swapProp.figma.property]) != null ? _h : [] : [];
        if (declared.length) {
          const hint = el("div", "studio-swap-hint");
          for (const t2 of declared) {
            const known = names.includes(t2.name);
            const line = el("div", "studio-swap-line");
            line.appendChild(el("span", "studio-note-conf", t2.role));
            if (known) {
              const b = el("button", "studio-toggle", `accept ${t2.name}`);
              b.addEventListener("click", () => studioEdit((def) => {
                var _a29;
                const tgt = slotsOf(def).find((x) => x.path === path);
                if (!tgt) return;
                const a = tgt.node.slot.accepts = (_a29 = tgt.node.slot.accepts) != null ? _a29 : [];
                if (!a.includes(t2.name)) a.push(t2.name);
              }));
              line.appendChild(b);
            } else {
              line.appendChild(el("span", void 0, `${t2.name} \u2014 no contract yet, so it cannot be accepted. Extract it first.`));
            }
    ...
    const tokens = studioSection(`Root tokens \xB7 ${Object.keys(toks).length}`);
  ...
  var studioAwaitingExtract = false;
  var studioSwapTargets = {};
  var studioEditor = null;
  function studioExtract(btn, name2 = "", rename = false) {
    if (!studioSel) return;
    sendTelemetry("action:studio-extract");
    studioAwaitingExtract = true;
    btn.disabled = true;
    btn.textContent = "Reading the set\u2026";
    postToPlugin("contract:extract", { setId: studioSel.id, name: name2, rename });
  }
  async function studioOnEvidence(msg) {
    var _a28, _b, _c, _d;
    const reset = () => {
      const b = document.querySelector("#studioGui .btn");
      if (b) {
        b.disabled = false;
        b.textContent = "Extract this set";
      }
    };
    const fail = (text) => {
      $s("studioVerdict").className = "studio-verdict bad";
      $s("studioVerdict").textContent = text;
      reset();
    };
    ...
    try {
      ...
      const res = await fetch(`${contractEndpoint.replace(/\/$/, "")}/evidence`, {
        ...
        body: JSON.stringify({ evidence, hash })
      });
      const out = await res.json();
      if (!res.ok) throw new Error(out.error || `sync endpoint returned ${res.status}`);
      contractIndexCache = null;
      studioOpen(String((_c = (_a28 = out.slug) != null ? _a28 : studio.slug) != null ? _c : (_b = evidence.set) == null ? void 0 : _b.name), out.slug ? "slug" : "name");
    } catch (err) {
      fail(`Could not publish the evidence: ${(_d = err == null ? void 0 : err.message) != null ? _d : err}`);
    }
  }
  function studioRenderEmpty(hasEvidence) {
    const host = $s("studioGui");
    host.innerHTML = "";
    if (!hasEvidence) {
      ...
      const isFrame = (studioSel == null ? void 0 : studioSel.nodeType) === "FRAME";
      let nameInput;
      let renameBox;
      if (isFrame) {
      ...
      const btn2 = el("button", "btn", "Extract this set");
      btn2.style.flex = "1";
      btn2.disabled = !studioSel;
      if (!studioSel) btn2.title = "Select the component set in Figma first";
      btn2.addEventListener("click", () => {
        var _a28;
        const name2 = (_a28 = nameInput == null ? void 0 : nameInput.value.trim()) != null ? _a28 : "";
        if (isFrame && !name2) {
        ...
        studioExtract(btn2, name2, Boolean(renameBox == null ? void 0 : renameBox.checked));
      });
    ...
    const btn = el("button", "btn", "Draft a contract from the evidence");
    btn.style.flex = "1";
    btn.addEventListener("click", async () => {
      ...
      try {
        const res = await studioApi("/draft", { method: "POST", body: JSON.stringify({ slug: studio.slug, name: studioSel == null ? void 0 : studioSel.name }) });
        const out = await res.json().catch(() => ({}));
        if (!res.ok) throw new Error((_a28 = out.error) != null ? _a28 : res.status === 404 ? "Sync server is running older code. Restart it: npm run contract-sync (in apps/s2a-toolkit)." : `draft failed (${res.status})`);
        studio.def = out.def;
        studio.dirty = true;
        studio.validation = null;
        studioRender();
        ...
        btn.disabled = false;
        btn.textContent = "Draft a contract from the evidence";
        $s("studioVerdict").className = "studio-verdict bad";
        $s("studioVerdict").textContent = `Could not draft: ${(_b = err.message) != null ? _b : err}`;
      }
    });
    row.appendChild(btn);
    host.appendChild(row);
  ...
  function studioRenderNotes() {
    ...
    const notes = ((_b = (_a28 = studio.def) == null ? void 0 : _a28.decisions) != null ? _b : []).filter((n) => n.status === "open");
    if (!notes.length) {
      host.style.display = "none";
      host.innerHTML = "";
      return;
    }
    const low = notes.filter((n) => n.confidence === "low").length;
    host.innerHTML = "";
    host.appendChild(el(
      "div",
      "studio-notes-head",
      `${notes.length} judgment call${notes.length === 1 ? "" : "s"} to review${low ? ` \xB7 ${low} low confidence` : ""}`
    ));
    const band = (c) => c === "low" ? 0 : c === "medium" ? 1 : 2;
    for (const n of [...notes].sort((a, b) => band(a.confidence) - band(b.confidence)).slice(0, 6)) {
      const row = el("div", "studio-note");
      const conf = el("span", `studio-note-conf${n.confidence === "low" ? " low" : ""}`, (_c = n.confidence) != null ? _c : "\u2014");
      const body = el("span", void 0, n.chose ? n.chose : n.question);
  ...
  function studioRender() {
    var _a28, _b, _c, _d, _e, _f, _g;
    const d = studio.def;
    $s("studioId").textContent = (d == null ? void 0 : d.component) ? `${d.component} \xB7 ${studio.slug}` : (_a28 = studio.slug) != null ? _a28 : "\u2014";
    const set = (_b = studio.evidence) == null ? void 0 : _b.set;
    $s("studioSub").textContent = set ? `${(_c = set.name) != null ? _c : ""} \xB7 ${(_f = (_e = (_d = studio.evidence) == null ? void 0 : _d.axes) == null ? void 0 : _e.length) != null ? _f : 0} axes` : (_g = studio.slug) != null ? _g : "";
    $s("studioDraftChip").style.display = (d == null ? void 0 : d.status) === "curated-draft" ? "inline-block" : "none";
    studioRenderNotes();
    if (studio.jsonMode) {
      studioRenderFooter();
      return;
  ...
  function studioSetMode(json2) {
    if (!json2 && studio.jsonMode && studio.jsonError) return;
    studio.jsonMode = json2;
    $s("studioModeGui").classList.toggle("active", !json2);
    $s("studioModeJson").classList.toggle("active", json2);
    $s("studioGui").style.display = json2 ? "none" : "block";
    $s("studioJsonWrap").style.display = json2 ? "block" : "none";
    if (json2) studioMountEditor();
    studioRender();
  }
    ...
    studioEditor = createJsonEditor(host, {
      ...
      onChange: (value) => {
        ...
        try {
          ...
          studio.jsonError = String((_a28 = err == null ? void 0 : err.message) != null ? _a28 : err).replace(/^JSON\.parse: /, "");
          studio.validation = null;
        }
        studioRenderFooter();
      },
      ...
      externalDiagnostics: () => {
        var _a28, _b;
        return ((_b = (_a28 = studio.validation) == null ? void 0 : _a28.errors) != null ? _b : []).map((message) => ({
          from: 0,
          to: 0,
          severity: "warning",
          message
  ...
  function studioUnmountEditor() {
    studioEditor == null ? void 0 : studioEditor.destroy();
    studioEditor = null;
  }
  var _a10;
  (_a10 = document.getElementById("studioOpenBtn")) == null ? void 0 : _a10.addEventListener("click", () => {
    if (!studioSel) return;
    sendTelemetry("action:studio-open");
    studioOpen(studioSel.name, "name");
  });
  var _a11;
  (_a11 = document.getElementById("studioBackBtn")) == null ? void 0 : _a11.addEventListener("click", () => {
    studioUnmountEditor();
    studioShow("list");
    studioRefreshIndex();
  });
  var _a12;
  (_a12 = document.getElementById("studioModeGui")) == null ? void 0 : _a12.addEventListener("click", () => studioSetMode(false));
  var _a13;
  for (const [id, depth] of [["studioFold1", 1], ["studioFold2", 2], ["studioFold3", 3]]) {
    (_a13 = document.getElementById(id)) == null ? void 0 : _a13.addEventListener("click", () => studioEditor == null ? void 0 : studioEditor.foldToDepth(depth));
  }
  var _a14;
  (_a14 = document.getElementById("studioUnfold")) == null ? void 0 : _a14.addEventListener("click", () => studioEditor == null ? void 0 : studioEditor.unfoldAll());
  var _a15;
  (_a15 = document.getElementById("studioModeJson")) == null ? void 0 : _a15.addEventListener("click", () => studioSetMode(true));
  var _a16;
  (_a16 = document.getElementById("studioPublishBtn")) == null ? void 0 : _a16.addEventListener("click", async () => {
    var _a28, _b, _c, _d, _e, _f;
    if (!canPublish(studio) || !studio.def) return;
    sendTelemetry("action:studio-publish");
    const btn = $s("studioPublishBtn");
    studio.busy = true;
    btn.disabled = true;
    ...
    try {
      ...
      const out = await res.json();
      studioResult = res.ok ? { tone: "ok", text: `Saved to ${(_c = (_b = (_a28 = out.defs) == null ? void 0 : _a28[0]) == null ? void 0 : _b.path) != null ? _c : "the repo"} \u2014 regenerate and run the gate.` } : { tone: "bad", text: `Failed: ${((_e = out.errors) != null ? _e : [(_d = out.error) != null ? _d : res.status]).slice(0, 2).join(" \xB7 ")}` };
      studio.dirty = !res.ok;
    } catch (err) {
      studioResult = { tone: "bad", text: `Failed: ${(_f = err.message) != null ? _f : err}` };
    } finally {
      studio.busy = false;
      btn.textContent = "Publish contract \u2192";
      studioRenderFooter();
    }
  });
  ...
  function setContractStatus(msg, type = "") {
    const el2 = document.getElementById("contractStatus");
    el2.innerHTML = msg;
    el2.className = "status" + (type ? " " + type : "");
  }
  function contractSlug(name2) {
    return name2.replace(/[\u{1F300}-\u{1FAFF}\u{2600}-\u{27BF}]/gu, "").replace(/\s*[—–-]\s*v\d+(\.\d+)*\s*$/i, "").replace(/\(.*?\)/g, "").trim().replace(/([a-z0-9])([A-Z])/g, "$1-$2").replace(/[^A-Za-z0-9]+/g, "-").replace(/^-+|-+$/g, "").toLowerCase();
  }
  ...
  function sha256Sync(text) {
    ...
    for (let off = 0; off < padded.length; off += 64) {
      for (let i2 = 0; i2 < 16; i2++) w[i2] = dv.getUint32(off + i2 * 4);
  ...
  async function sha256Hex(text) {
    var _a28;
    try {
      if ((_a28 = globalThis.crypto) == null ? void 0 : _a28.subtle) {
  ...
  function runContractExtract() {
    ...
    const name2 = contractIsFrame ? document.getElementById("contractNameInput").value.trim() : "";
    const rename = contractIsFrame && document.getElementById("contractRenameLayer").checked;
    contractLog("extract:start", { setId: contractSetId, name: name2 || void 0 });
    const btn = document.getElementById("contractExtractBtn");
    btn.disabled = true;
    btn.textContent = "Extracting\u2026";
    setContractStatus("");
    postToPlugin("contract:extract", { setId: contractSetId, name: name2, rename });
  }
  var _a17;
  (_a17 = document.getElementById("contractExtractBtn")) == null ? void 0 : _a17.addEventListener("click", runContractExtract);
  var _a18;
  (_a18 = document.getElementById("contractCopyBtn")) == null ? void 0 : _a18.addEventListener("click", async () => {
  ...
  var _a19;
  (_a19 = document.getElementById("contractPublishBtn")) == null ? void 0 : _a19.addEventListener("click", async () => {
    if (!contractEvidence) return;
  ...
  async function onContractEvidence(msg) {
    var _a28, _b;
    if (studioAwaitingExtract) {
      studioAwaitingExtract = false;
      void studioOnEvidence(msg);
      return;
    }
    const btn = document.getElementById("contractExtractBtn");
    ...
    try {
      ...
      const nested = [...new Set(instances.map((i2) => {
        var _a29;
        return (_a29 = i2.set) == null ? void 0 : _a29.name;
      }).filter(Boolean))];
      const meta2 = evidence.set.meta;
      const pattern = evidence.pattern;
      const summary = document.getElementById("contractSummary");
      summary.textContent = [
        `${meta2.version ? "v" + meta2.version + (meta2.status ? " \xB7 " + meta2.status : "") : "no s2a:meta version"}`,
  ...
  async function showContractMatch(evidence) {
    const el2 = document.getElementById("contractMatch");
    try {
  ...
  var _a21;
  (_a21 = document.getElementById("contractEndpointSaveBtn")) == null ? void 0 : _a21.addEventListener("click", () => {
  ...
  window.addEventListener("message", (event) => {
    ...
    switch (msg.type) {
      ...
      case "select:result": {
        const el2 = document.getElementById("selectStatus");
        if (el2) {
          el2.textContent = msg.message;
          el2.className = "status ok";
        }
        break;
      }
      case "selection-changed": {
        if (msg.nodeId) {
          ...
          updateDocCheckSelection(__spreadProps(__spreadValues({}, sel), { width: msg.width, height: msg.height }));
          studioSetSelection(sel);
          void updateContractSelection(sel);
          updateCopyBtn(sel, msg.fileKey, msg.fileName, msg.allNodes);
          updateSectionBar(
            !!msg.isSection,
            (_a28 = msg.sectionCount) != null ? _a28 : 0,
      ...
      case "contract:artifact": {
        fetch(`${contractEndpoint.replace(/\/$/, "")}/artifact`, { method: "POST", headers: contractHeaders(), body: JSON.stringify({ name: msg.name, b64: msg.b64 }) }).then((r) => r.json()).then((r) => {
          contractLog("artifact:saved", r);
          parent.postMessage({ pluginMessage: { type: "contract:artifact:saved", name: msg.name, result: r } }, "*");
        }).catch((err) => contractLog("artifact:error", (err == null ? void 0 : err.message) || String(err)));
        break;
      }
      ...
      case "studio:swap-targets-result": {
        studioSwapTargets = (_j = msg.targets) != null ? _j : {};
      ...
      case "docs:check-result": {
        const btn = document.getElementById("docCheckBtn");
        btn.disabled = false;
        btn.textContent = "Check readability";
        const status = document.getElementById("docCheckStatus");
        const list = document.getElementById("docCheckIssues");
        if (msg.error) {
          status.textContent = String(msg.error);
          list.style.display = "none";
          list.innerHTML = "";
          break;
        }
        const fails = msg.fails, warns = msg.warns;
        status.textContent = fails === 0 && warns === 0 ? `Pass \u2014 ${msg.textNodes} text nodes, theme ${(_k = msg.theme) != null ? _k : "?"}` : `${fails} to fix, ${warns} to look at \u2014 ${msg.textNodes} text nodes`;
        const issues = (_l = msg.issues) != null ? _l : [];
        if (!issues.length) {
          list.style.display = "none";
          list.innerHTML = "";
          break;
        }
        const order = (l) => l === "fail" ? 0 : 1;
        list.innerHTML = "";
        for (const i2 of [...issues].sort((a, b) => order(a.level) - order(b.level))) {
          const row = document.createElement("div");
          row.style.cssText = "font-size:10.5px; line-height:1.45; padding:4px 6px; margin-bottom:3px; border-left:2px solid " + (i2.level === "fail" ? "#d4594a" : "#b8862b") + "; cursor:" + (i2.nodeId ? "pointer" : "default") + ";";
          row.textContent = `${i2.level === "fail" ? "fix" : "look"} \xB7 ${i2.code} \u2014 ${i2.message}`;
          if (i2.nodeId) row.addEventListener("click", () => postToPlugin("docs:reveal", { nodeId: i2.nodeId }));
  ...
  function setTokenReleaseStatus(msg, type = "") {
    const el2 = document.getElementById("tokenReleaseStatus");
    el2.innerHTML = msg;
    el2.className = "status" + (type ? " " + type : "");
  }
  ...
  var _a22;
  (_a22 = document.getElementById("ghTokenSaveBtn")) == null ? void 0 : _a22.addEventListener("click", () => {
  ...
  var _a23;
  (_a23 = document.getElementById("ghTokenClearBtn")) == null ? void 0 : _a23.addEventListener("click", () => {
    ghToken = null;
  ...
  var _a24;
  (_a24 = document.getElementById("tokenReleaseBtn")) == null ? void 0 : _a24.addEventListener("click", async () => {
    var _a28;
    if (!ghToken) return;
  ...
  function setReqStatus(msg, type = "") {
    const el2 = document.getElementById("reqStatus");
    el2.innerHTML = msg;
    el2.className = "status" + (type ? " " + type : "");
  }
  ...
  function renderReqImages() {
    ...
    wrap.innerHTML = reqImages.map(
      (img, i2) => `<div class="req-thumb"><img src="${img.dataUrl}" alt="${esc(img.name)}"><button class="req-thumb-rm" data-i="${i2}" title="Remove image" type="button">\xD7</button></div>`
    ).join("");
  ...
  var _a25;
  (_a25 = document.getElementById("reqAddImageBtn")) == null ? void 0 : _a25.addEventListener("click", () => {
    document.getElementById("reqImageInput").click();
  });
  var _a26;
  (_a26 = document.getElementById("reqImageInput")) == null ? void 0 : _a26.addEventListener("change", (e) => {
  ...
  var _a27;
  (_a27 = document.getElementById("reqSubmitBtn")) == null ? void 0 : _a27.addEventListener("click", async () => {
    var _a28;
      ...
      if (REQUEST_ENDPOINT) {
        const res = await fetch(REQUEST_ENDPOINT, {
          ...
          body: JSON.stringify({
            ...
            nodeName: (_a28 = ctx == null ? void 0 : ctx.node) == null ? void 0 : _a28.name,
            tokenName: ctx == null ? void 0 : ctx.tokenName,
            requester: ctx == null ? void 0 : ctx.user,
            images: reqImages.map((i2) => ({ name: i2.name, type: i2.type, dataUrl: i2.dataUrl }))
          })
        });
