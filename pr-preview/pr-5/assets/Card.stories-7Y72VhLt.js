import{E as C,x as a}from"./iframe-LJ3r8Nkr.js";import{P as y,p as _}from"./progress-bar-BICcT3hU.js";import{A as S}from"./app-icon-C6T8eNvs.js";import"./preload-helper-B3-uKv5j.js";const o=({label:n="Card label",body:e,tone:t="knockout",orientation:k="horizontal",active:w=!1,showProgress:P=!1,progress:$=0,onClick:I}={})=>{const m=!!P,x=t==="default"?"default":"knockout";return a`
    <button
      class="c-card"
      data-tone=${x}
