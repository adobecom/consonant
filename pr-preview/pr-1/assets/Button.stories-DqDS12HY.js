import{x as e}from"./iframe-DCFCIy-N.js";import{B as r}from"./button-CUegMz2r.js";import{t as c,I as f,s as k,o as x}from"./define-element-CfrMXfwC.js";import"./preload-helper-kk50mwSr.js";const S=`.c-button {
...
`,$=({width:n=24,height:t=24,hidden:a=!1,title:o="Download"}={})=>c`<svg
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`,I=({width:n=24,height:t=24,hidden:a=!1,title:o="Save To"}={})=>c`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${t}"
    viewBox="0 0 36 36"
    width="${n}"
  ...
  >
    ...
    />
  </svg>`;class C extends f{render(){return k(e),this.spectrumVersion===2?$({hidden:!this.label,title:this.label}):I({hidden:!this.label,title:this.label})}}x("sp-icon-download",C);const D=({width:n=24,height:t=24,hidden:a=!1,title:o="Folder"}={})=>c`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${n}"
    height="${t}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`,B=({width:n=24,height:t=24,hidden:a=!1,title:o="Folder Outline"}={})=>c`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${t}"
    viewBox="0 0 36 36"
    width="${n}"
  ...
  >
    ...
    />
  </svg>`;class _ extends f{render(){return k(e),this.spectrumVersion===2?D({hidden:!this.label,title:this.label}):B({hidden:!this.label,title:this.label})}}x("sp-icon-folder",_);const z=({width:n=24,height:t=24,hidden:a=!1,title:o="Chevron Down"}={})=>c`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${n}"
    height="${t}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`,E=({width:n=24,height:t=24,hidden:a=!1,title:o="Chevron Down"}={})=>c`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${t}"
    viewBox="0 0 36 36"
    width="${n}"
  ...
  >
    ...
    />
  </svg>`;class F extends f{render(){return k(e),this.spectrumVersion===2?z({hidden:!this.label,title:this.label}):E({hidden:!this.label,title:this.label})}}x("sp-icon-chevron-down",F);const{fn:T}=__STORYBOOK_MODULE_TEST__,y="width:12px;height:12px;display:inline-flex;align-items:center;justify-content:center;",O=()=>e`<sp-icon-download aria-hidden="true" style="${y}"></sp-icon-download>`,Z=()=>e`<sp-icon-folder aria-hidden="true" style="${y}"></sp-icon-folder>`,w=()=>e`<sp-icon-chevron-down aria-hidden="true" style="${y}"></sp-icon-chevron-down>`,A={title:"Components/Button",tags:["autodocs"],render:n=>r(n),parameters:{docs:{description:{component:`
<style>
.doc-pattern {
  ...
  `},g={render:()=>{const n=["solid","outlined","transparent"];return e`
      <div style="display: flex; flex-direction: column; gap: 24px;">
        <div style="display: flex; gap: 16px; flex-wrap: wrap;">
          ${n.map(t=>r({label:t,background:t,context:"on-light"}))}
        </div>
        <div style="background: #050505; padding: 24px; border-radius: 24px; display: flex; gap: 16px; flex-wrap: wrap;">
          ${n.map(t=>r({label:`${t} on dark`,background:t,context:"on-dark"}))}
        </div>
      </div>
    `}},v={render:()=>e`
    <div style="display: flex; gap: 16px; flex-wrap: wrap;">
      ${r({label:"Download presets",showIconStart:!0,iconStart:O,showIconEnd:!0,iconEnd:w})}
      ${r({intent:"accent",background:"solid",showIconStart:!0,iconStart:Z,label:"Save to library"})}
    </div>
  `},h={render:()=>e`
    <div style="background: #050505; padding: 24px; border-radius: 24px; display: flex; gap: 16px; flex-wrap: wrap;">
      ${r({label:"Get started",intent:"accent",background:"solid",context:"on-dark"})}
      ${r({label:"Learn more",background:"outlined",context:"on-dark"})}
      ${r({label:"Dismiss",background:"transparent",context:"on-dark"})}
    </div>
  `},m={render:()=>e`
      <div style="display: flex; gap: 16px; flex-wrap: wrap;">
        ${["default","hover","active","focus","disabled"].map(t=>r({label:t,state:t,context:"on-light",background:"solid"}))}
      </div>
...
}`,...m.parameters?.docs?.source}}};const L=["Solid","Outlined","Transparent","Disabled","Accent","Dropdown","Sizes","ContextGrid","IconSlots","OnDark","ForcedStates"];export{u as Accent,g as ContextGrid,l as Disabled,b as Dropdown,m as ForcedStates,v as IconSlots,h as OnDark,d as Outlined,p as Sizes,s as Solid,i as Transparent,L as __namedExportsOrder,A as default};
