import{E as C,x as a}from"./iframe-DLfCAtFK.js";import{P as y,p as _}from"./progress-bar-CTrkBJ7u.js";import{A as S}from"./app-icon-CWnWkt0J.js";import"./preload-helper-d1_5Ul3d.js";const o=({label:n="Card label",body:e,tone:t="knockout",orientation:k="horizontal",active:w=!1,showProgress:P=!1,progress:$=0,onClick:I}={})=>{const m=!!P,x=t==="default"?"default":"knockout";return a`
    <button
      class="c-card"
      data-tone=${x}
