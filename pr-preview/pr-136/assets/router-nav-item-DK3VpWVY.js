import{x as c}from"./iframe-DGf3QGPt.js";import{P as n}from"./product-lockup-CqQk9cjU.js";const p=({label:a="Product",app:o="experience-cloud",orientation:r="block",state:i="default",onClick:s}={})=>{const t=i==="active",e=r==="block";return c`
    <button
