import{E as a,x as s}from"./iframe-BZTzb1tM.js";import{o as P}from"./unsafe-html-JFwMZT8i.js";import{P as F}from"./product-lockup-AzUIgYkm.js";import{c as Z}from"./chevron-right-CnbUzkxe.js";import{a as q}from"./arrow-right-Do-kvyXB.js";const B=new Set(["16:9","4:3","1:1","3:2","3:4","21:9"]),G=new Set(["xs","sm","md","lg","xl","full"]),H=new Set(["cover","contain","fill","none","scale-down"]),J=new Set(["center","top","bottom","left","right","top-left","top-right","bottom-left","bottom-right"]),h=(e,c,t)=>c.has(e)?e:t,K=({src:e,alt:c,lazy:t,decoding:o="async",objectPosition:n})=>s`
  <img
    src=${e??""}
    alt=${c??""}
