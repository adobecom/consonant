import{E as C,x as a}from"./iframe-2kp_66TH.js";import{P as y,p as _}from"./progress-bar-C27l2jnE.js";import{A as S}from"./app-icon-WoedoEne.js";import"./preload-helper-DOg3i_cw.js";const o=({label:n="Card label",body:e,tone:t="knockout",orientation:k="horizontal",active:w=!1,showProgress:P=!1,progress:$=0,onClick:I}={})=>{const m=!!P,x=t==="default"?"default":"knockout";return a`
    <button
      class="c-card"
      data-tone=${x}
