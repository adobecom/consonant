import{E as t,x as o}from"./iframe-jOOov1r8.js";import{P as E}from"./product-lockup-CnYjtgxi.js";import{P as F,p as L}from"./progress-bar-DQChlZi2.js";import{p as T}from"./product-lockup-Bc6IBSkQ.js";import"./preload-helper-DVtt2fnc.js";import"./app-icon-cFEMNSbv.js";const V=e=>e==="horizontal"?"horizontal":"vertical",B=e=>e==="eyebrow"?"eyebrow":"label",N=e=>e==="on-dark"?"on-dark":"on-light",O=e=>e==="hug"?"hug":"fill",W=e=>{const r=Number.parseInt(e,10);return Number.isNaN(r)?0:Math.min(100,Math.max(0,r))},j=(e,r)=>e?"a":r?"button":"div",p=({label:e="PDF and productivity",app:r="acrobat-pro",orientation:x="vertical",styleVariant:h="label",context:y="on-light",width:w="fill",showIconStart:k=!0,showIconEnd:$=!0,iconSize:P="auto",active:d=!1,showProgress:q=!0,progress:_="50",body:I,children:u,href:m,ariaLabel:S,onClick:g}={})=>{const b=V(x),z=B(h),f=N(y),C=O(w),M=W(_),A=I??E({label:e,app:r,orientation:b,styleVariant:z,context:f,width:C,showIconStart:k,showIconEnd:$,iconSize:P}),a=j(m,g),R=!!u,v=!!q,D=o`
    ${A}
