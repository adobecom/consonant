import{x as d}from"./iframe-C_8D3Tr5.js";import"./preload-helper-VQDTFHr9.js";const l=r=>{const a=Number.parseInt(r,10);return Number.isNaN(a)?0:Math.min(100,Math.max(0,a))},s=({progress:r=0}={})=>{const a=l(r);return d`
