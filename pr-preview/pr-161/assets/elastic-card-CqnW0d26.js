import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{i as t,s as n,t as r}from"./lit-UMo5x0iS.js";import{r as i,t as a}from"./unsafe-html-K3HXmifv.js";import{n as o,t as s}from"./chevron-right-C2fDtaFH.js";import{n as c,t as l}from"./product-lockup-drfgdkTx.js";import{n as u,t as d}from"./arrow-right-CbD2Dsf5.js";var f,p,m,h,g,_,v,y,b;function x(){return(x=e((()=>{r(),f=new Set([`16:9`,`4:3`,`1:1`,`3:2`,`3:4`,`21:9`]),p=new Set([`xs`,`sm`,`md`,`lg`,`xl`,`full`]),m=new Set([`cover`,`contain`,`fill`,`none`,`scale-down`]),h=new Set([`center`,`top`,`bottom`,`left`,`right`,`top-left`,`top-right`,`bottom-left`,`bottom-right`]),g=(e,t,n)=>t.has(e)?e:n,_=({src:e,alt:r,lazy:i,decoding:a=`async`,objectPosition:o})=>n`
  <img
    src=${e??``}
    alt=${r??``}
...
`,D=(e,t,n)=>e||(t?`a`:typeof n==`function`?`button`:`article`),O=(e,t,n)=>t.has(e)?e:n,k=({state:e=`resting`,type:r=`standard`,label:i=`Creativity and design`,app:a=`experience-cloud`,product:o={},heading:s,title:c=`Card title`,body:u=`Card description goes here and can wrap to multiple lines.`,mediaSrc:d,mediaAlt:f=``,mediaTemplate:p,mediaAspect:m=`3:4`,mediaOverlay:h=!0,bodyTemplate:g,children:_,showCaret:v,actionTemplate:y,actionLabel:x,href:k,ariaLabel:A,onClick:j,tag:M}={})=>{let N=O(e,S,`resting`),P=O(r,C,`standard`),F=O(m,w,`3:4`),I=D(M,k,j),L={width:N===`resting`?o.width??`hug`:`fill`,showIconEnd:o.showIconEnd??!1,orientation:o.orientation??`horizontal`,styleVariant:o.styleVariant??o.style??`label`,...o,label:o.label??i,app:o.app??a};delete L.context;let R=P===`featured`?n`<p class="c-elastic-card__heading">${s??i}</p>`:l(L),z=y!=null,B=z?n`<span class="c-elastic-card__action" aria-label=${x??t}>${y}</span>`:N===`mobile`?E():v??!1?n`<span class="c-elastic-card__action c-elastic-card__action--caret" aria-hidden="true">
    ...
    <p class="c-elastic-card__title">${c}</p>
