import{x as o}from"./iframe-Ct7mL2BY.js";import{N as n}from"./nav-card-button-E_sh866K.js";import"./preload-helper-BizvS7Gc.js";const p={title:"Organisms/NavCard/CTA Button",tags:["autodocs"],render:s=>o`<div style="padding: 32px; background: #f5f5f5; width: 340px;">${n(s)}</div>`,parameters:{docs:{description:{component:"GNAV pill CTA used under every nav card/menu item."},source:{language:"html",code:`<!-- Link variant (most common) -->
