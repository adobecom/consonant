import{x as e,E as r}from"./iframe-DReoqYbu.js";import{o as z}from"./unsafe-html-DgchQatj.js";import{A as S}from"./app-icon-Csi4OqYZ.js";import{a as G}from"./arrow-right-Do-kvyXB.js";import"./preload-helper-DUW8wTBw.js";import"./directive-DoeGSK_T.js";const L=new Set(["card","feature"]),F=(a,c,l)=>c.has(a)?a:l,b=()=>e`<span class="c-media-card__cta-arrow" aria-hidden="true">${z(G)}</span>`,t=({size:a="card",app:c="experience-cloud",showIcon:l=!0,mediaSrc:f,mediaAlt:v="",mediaTemplate:w,title:g="",body:u="",ctaLabel:p="",ctaHref:y,onClick:I}={})=>{const A=F(a,L,"card"),C=w??(f?e`<img class="c-media-card__media-img" src=${f} alt=${v} loading="lazy" decoding="async" />`:e`<span class="c-media-card__media-placeholder" aria-hidden="true"></span>`),$=!!p?y?e`<a class="c-media-card__cta" href=${y}><span class="c-media-card__cta-label">${p}</span>${b()}</a>`:e`<button class="c-media-card__cta" type="button" @click=${I??r}><span class="c-media-card__cta-label">${p}</span>${b()}</button>`:r;return e`
...
<div class="c-media-card" data-size="feature">
  ...
  `},d={name:"Full Section (homepage)",parameters:{layout:"fullscreen"},render:()=>e`
    <div style="
      display: flex;
  ...
  `},o={name:"No Icon",args:{showIcon:!1,mediaSrc:h,title:"Blend images seamlessly with Harmonize.",body:"Combine people and objects into any background instantly.",ctaLabel:"Explore Photoshop",ctaHref:"#"},render:a=>e`
    <div style="max-width: 488px; padding: 24px;">
      ${t(a)}
    </div>
  ...
  \`
}`,...o.parameters?.docs?.source}}};const U=["Card","Feature","ThreeUpGrid","FullSection","NoIcon"];export{i as Card,n as Feature,d as FullSection,o as NoIcon,s as ThreeUpGrid,U as __namedExportsOrder,R as default};
