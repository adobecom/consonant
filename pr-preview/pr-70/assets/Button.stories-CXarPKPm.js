import{x as n}from"./iframe-D8Il5B1U.js";import{B as o}from"./button-CcCohb0A.js";import{t as s,I as x,s as w,o as y}from"./define-element-CPBRKlzI.js";import"./preload-helper-CaDq-G7y.js";import"./unsafe-html-QbazDVPs.js";import"./chevron-down-Bqt06uWP.js";const I=({width:e=24,height:t=24,hidden:a=!1,title:r="Download"}={})=>s`<svg
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`,z=({width:e=24,height:t=24,hidden:a=!1,title:r="Save To"}={})=>s`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${t}"
    viewBox="0 0 36 36"
    width="${e}"
  ...
  >
    ...
    />
  </svg>`;class C extends x{render(){return w(n),this.spectrumVersion===2?I({hidden:!this.label,title:this.label}):z({hidden:!this.label,title:this.label})}}y("sp-icon-download",C);const D=({width:e=24,height:t=24,hidden:a=!1,title:r="Folder"}={})=>s`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${e}"
    height="${t}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`,T=({width:e=24,height:t=24,hidden:a=!1,title:r="Folder Outline"}={})=>s`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${t}"
    viewBox="0 0 36 36"
    width="${e}"
  ...
  >
    ...
    />
  </svg>`;class F extends x{render(){return w(n),this.spectrumVersion===2?D({hidden:!this.label,title:this.label}):T({hidden:!this.label,title:this.label})}}y("sp-icon-folder",F);const Z=({width:e=24,height:t=24,hidden:a=!1,title:r="Chevron Down"}={})=>s`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${e}"
    height="${t}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`,M=({width:e=24,height:t=24,hidden:a=!1,title:r="Chevron Down"}={})=>s`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${t}"
    viewBox="0 0 36 36"
    width="${e}"
  ...
  >
    ...
    />
  </svg>`;class O extends x{render(){return w(n),this.spectrumVersion===2?Z({hidden:!this.label,title:this.label}):M({hidden:!this.label,title:this.label})}}y("sp-icon-chevron-down",O);const{fn:V}=__STORYBOOK_MODULE_TEST__,k="width:12px;height:12px;display:inline-flex;align-items:center;justify-content:center;",E=()=>n`<sp-icon-download
    aria-hidden="true"
    style="${k}"
  ></sp-icon-download>`,_=()=>n`<sp-icon-folder
    aria-hidden="true"
    style="${k}"
  ></sp-icon-folder>`,A=()=>n`<sp-icon-chevron-down
    aria-hidden="true"
    style="${k}"
  ></sp-icon-chevron-down>`,R={title:"Atoms/Button",tags:["autodocs"],render:e=>o(e),parameters:{docs:{description:{component:"<p>Primary action button. Matches Figma <code>.Button/Core/Primary</code> node <code>141:53460</code>. Source: <code>packages/components/src/button/button.css</code>.</p>"},source:{language:"html",code:`<!-- Solid / on-light (default) -->
...
<a class="c-button" data-background="solid" data-intent="primary" data-context="on-light" data-size="md" href="/destination">
  ...
  `},b={render:()=>n`
    ...
    <div
      ...
      "
    >
      ${o({label:"outlined on-light",background:"outlined",context:"on-light"})}
      ${o({label:"outlined on-dark",background:"outlined",context:"on-dark"})}
      ${o({label:"transparent on-light",background:"transparent",context:"on-light"})}
      ${o({label:"transparent on-dark",background:"transparent",context:"on-dark"})}
    </div>
  `},f={render:()=>{const e=["solid","outlined","transparent"],t=["on-light","on-dark"],a=["md","xs"],r=["default","hover","active","focus","disabled"];return n`
      <div style="display: grid; gap: 28px;">
        ${t.map(v=>n`
            <section
              style=${v==="on-dark"?"background:#050505;color:#fff;padding:24px;border-radius:24px;":"background:#fff;color:#000;padding:24px;border:1px solid rgba(0,0,0,0.08);border-radius:24px;"}
            >
              <h3 style="margin:0 0 var(--s2a-spacing-md);font-family:var(--s2a-font-family-label);font-size:var(--s2a-font-size-md);font-weight:var(--s2a-font-weight-label);line-height:var(--s2a-typography-line-height-label);letter-spacing:var(--s2a-typography-letter-spacing-label);">${v}</h3>
                ...
                ${e.map($=>n`
                    <div style="display:grid;gap:12px;">
                      ...
                      ${a.map(S=>n`
                          ...
                          >
                            ${r.map(B=>o({label:`${S} ${B}`,background:$,context:v,size:S,state:B}))}
                          </div>
                        `)}
                    </div>
                  `)}
...
}`,...f.parameters?.docs?.source}}};const U=["Solid","Outlined","Transparent","Disabled","Accent","Sizes","ContextGrid","IconSlots","ForcedStates","BackdropBlur","PrimaryMatrix"];export{p as Accent,m as BackdropBlur,u as ContextGrid,c as Disabled,b as ForcedStates,h as IconSlots,i as Outlined,f as PrimaryMatrix,g as Sizes,l as Solid,d as Transparent,U as __namedExportsOrder,R as default};
