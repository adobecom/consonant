import{E as C,x as a}from"./iframe-DCFCIy-N.js";import{P as y,p as _}from"./progress-bar-B6gY0ASJ.js";import{A as S}from"./app-icon-CFVlH9pm.js";import"./preload-helper-kk50mwSr.js";const o=({label:n="Card label",body:e,tone:t="knockout",orientation:k="horizontal",active:w=!1,showProgress:P=!1,progress:$=0,onClick:I}={})=>{const m=!!P,x=t==="default"?"default":"knockout";return a`
    <button
      class="c-card"
      data-tone=${x}
