import{x as d}from"./iframe-_fPFkiU8.js";import{S as t}from"./section-header-BzKeV6bV.js";import{B as c}from"./button-BAw0RsDn.js";import"./preload-helper-BSds_FOV.js";import"./rich-content-BioJdVPP.js";import"./unsafe-html-Cu7DzaLd.js";import"./chevron-down-Bqt06uWP.js";const n=(e,l)=>d`
  <div style="
    width: 100%;
  ...
  <div class="c-rich-content" data-theme="on-light" data-density="tight" data-justify="center" data-measure="wide">
    <div class="c-rich-content__text">
      ...
      <p class="c-rich-content__body">Bring any idea to life with industry-leading creative tools.</p>
          ...
          ${c({label:"Get started",background:"solid",context:"on-light"})}
          ${c({label:"Learn more",background:"outlined",context:"on-light"})}
        `}))},i={name:"On Dark — With Actions",render:e=>n("#0f0d0c",t({...e,theme:"on-dark",showActions:!0,actions:d`
          ${c({label:"Get started",background:"solid",context:"on-dark"})}
          ${c({label:"Learn more",background:"outlined",context:"on-dark"})}
        `})),args:{theme:"on-dark"}},s={name:"Title Only",render:()=>n("#f8f8f8",t({showEyebrow:!1,title:"Everything you need to make anything.",theme:"on-light"}))};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  name: "On Light",
...
}`,...s.parameters?.docs?.source}}};const k=["OnLight","OnDark","WithActions","OnDarkWithActions","TitleOnly"];export{r as OnDark,i as OnDarkWithActions,o as OnLight,s as TitleOnly,a as WithActions,k as __namedExportsOrder,b as default};
