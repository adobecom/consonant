...
- `--s2a-id: xl`
- `--s2a-label: XL`
- `--s2a-typography-font-size-legal: var(--s2a-font-size-md)`
- `--s2a-typography-letter-spacing-legal: var(--s2a-font-letter-spacing-6xl)`
- `--s2a-typography-line-height-legal: var(--s2a-font-line-height-sm)`
- `--s2a-viewport-side-margins-margin-offset-reflow: var(--s2a-spacing-lg)`
- `--s2a-viewport-side-margins-margin-offset-reflow-legacy: 159.36px`
- `--s2a-viewport-side-margins-margin-reflow-default: 120px`
- `--s2a-viewport-side-margins-margin-reflow-legacy: 120px`
- `--s2a-viewport-visibility-lg: false`
- `--s2a-viewport-visibility-lg-md: false`
- `--s2a-viewport-visibility-lg-sm: false`
- `--s2a-viewport-visibility-md: false`
- `--s2a-viewport-visibility-md-sm: false`
- `--s2a-viewport-visibility-sm: false`
- `--s2a-viewport-visibility-xl: true`
- `--s2a-viewport-visibility-xl-lg: true`
- `--s2a-viewport-visibility-xl-md: true`

### 💥 Removed

- `--s2a-font-letter-spacing-neg-0_16` (was `-0.16px`)
- `--s2a-font-letter-spacing-neg-0_2` (was `-0.2px`)
- `--s2a-font-letter-spacing-neg-0_48` (was `-0.48px`)
- `--s2a-font-letter-spacing-neg-0_96` (was `-0.96px`)
- `--s2a-font-letter-spacing-neg-1_44` (was `-1.44px`)
- `--s2a-font-letter-spacing-neg-1_68` (was `-1.68px`)
- `--s2a-font-letter-spacing-neg-2_88` (was `-2.88px`)
- `--s2a-font-letter-spacing-neg-3_2` (was `-3.2px`)
- `--s2a-font-letter-spacing-neg-3_84` (was `-3.84px`)

### ♻️ Changed

- `--s2a-font-letter-spacing-3xl`: `var(--s2a-font-letter-spacing-neg-0_96)` → `var(--s2a-font-letter-spacing-neg-0-96)`
- `--s2a-font-letter-spacing-4xl`: `var(--s2a-font-letter-spacing-neg-0_48)` → `var(--s2a-font-letter-spacing-neg-0-48)`
- `--s2a-font-letter-spacing-5xl`: `var(--s2a-font-letter-spacing-neg-0_2)` → `var(--s2a-font-letter-spacing-neg-0-2)`
- `--s2a-font-letter-spacing-lg`: `var(--s2a-font-letter-spacing-neg-1_68)` → `var(--s2a-font-letter-spacing-neg-1-68)`
- `--s2a-font-letter-spacing-md`: `var(--s2a-font-letter-spacing-neg-2_88)` → `var(--s2a-font-letter-spacing-neg-2-88)`
- `--s2a-font-letter-spacing-sm`: `var(--s2a-font-letter-spacing-neg-3_2)` → `var(--s2a-font-letter-spacing-neg-3-2)`
- `--s2a-font-letter-spacing-xl`: `var(--s2a-font-letter-spacing-neg-1_44)` → `var(--s2a-font-letter-spacing-neg-1-44)`
- `--s2a-font-letter-spacing-xs`: `var(--s2a-font-letter-spacing-neg-3_84)` → `var(--s2a-font-letter-spacing-neg-3-84)`
...
- `--s2a-cards-immersive-padding: var(--s2a-spacing-2xl)`
- `--s2a-color-border-accent: #3b63fb`
- `--s2a-color-button-background-accent-active: var(--s2a-color-blue-1100)`
- `--s2a-color-button-background-accent-default: var(--s2a-color-blue-900)`
- `--s2a-color-button-background-accent-hover: var(--s2a-color-blue-1000)`
- `--s2a-color-button-background-knockout-active: var(--s2a-color-gray-100)`
- `--s2a-color-button-background-knockout-default: var(--s2a-color-gray-25)`
- `--s2a-color-button-background-knockout-hover: var(--s2a-color-gray-50)`
- `--s2a-color-button-background-outline-inverse-active: var(--s2a-color-transparent-white-16)`
- `--s2a-color-button-background-outline-inverse-default: var(--s2a-color-transparent-white-00)`
- `--s2a-color-button-background-outline-inverse-hover: var(--s2a-color-transparent-white-08)`
- `--s2a-color-button-background-outlined-active: var(--s2a-color-gray-1000)`
- `--s2a-color-button-background-outlined-default: var(--s2a-color-transparent-white-00)`
- `--s2a-color-button-background-outlined-hover: var(--s2a-color-transparent-black-08)`
- `--s2a-color-button-background-solid-active: var(--s2a-color-gray-1000)`
- `--s2a-color-button-background-solid-default: var(--s2a-color-gray-1000)`
- `--s2a-color-button-background-solid-hover: var(--s2a-color-transparent-black-64)`
- `--s2a-color-button-background-transparent-active: var(--s2a-color-transparent-black-12)`
- `--s2a-color-button-background-transparent-default: var(--s2a-color-transparent-black-00)`
- `--s2a-color-button-background-transparent-hover: var(--s2a-color-transparent-black-08)`
- `--s2a-color-button-border-knockout-default: var(--s2a-color-gray-25)`
- `--s2a-color-button-border-outline-inverse-default: var(--s2a-color-gray-25)`
- `--s2a-color-button-border-outlined-default: var(--s2a-color-gray-1000)`
- `--s2a-color-button-border-solid-default: var(--s2a-color-gray-1000)`
- `--s2a-color-button-content-accent-default: var(--s2a-color-gray-25)`
- `--s2a-color-button-content-knockout: var(--s2a-color-gray-1000)`
- `--s2a-color-button-content-outline-inverse: var(--s2a-color-gray-25)`
- `--s2a-color-button-content-outlined-active: var(--s2a-color-gray-25)`
- `--s2a-color-button-content-outlined-default: var(--s2a-color-gray-1000)`
- `--s2a-color-button-content-solid-default: var(--s2a-color-gray-25)`
- `--s2a-color-button-content-transparent-default: var(--s2a-color-gray-1000)`
- `--s2a-color-content-on-inverse: var(--s2a-color-gray-25)`
- `--s2a-color-content-on-inverse-subtle: var(--s2a-color-transparent-white-64)`
- `--s2a-color-control-button-background-media-active: var(--s2a-color-transparent-black-96)`
- `--s2a-color-control-button-background-media-default: var(--s2a-color-transparent-black-64)`
- `--s2a-color-control-button-background-media-disabled: var(--s2a-color-transparent-black-32)`
- `--s2a-color-control-button-background-media-focus: var(--s2a-color-transparent-black-64)`
- `--s2a-color-control-button-background-media-hover: var(--s2a-color-transparent-black-80)`
- `--s2a-color-control-button-background-solid-active: var(--s2a-color-gray-1000)`
- `--s2a-color-control-button-background-solid-default: var(--s2a-color-gray-75)`
- `--s2a-color-control-button-background-solid-disabled: var(--s2a-color-transparent-black-04)`
- `--s2a-color-control-button-background-solid-focus: var(--s2a-color-transparent-black-04)`
- `--s2a-color-control-button-background-solid-hover: var(--s2a-color-gray-300)`
- `--s2a-color-control-button-background-transparent-active: var(--s2a-color-transparent-white-08)`
- `--s2a-color-control-button-background-transparent-default: var(--s2a-color-transparent-white-32)`
- `--s2a-color-control-button-background-transparent-disabled: var(--s2a-color-transparent-white-16)`
- `--s2a-color-control-button-background-transparent-focus: var(--s2a-color-transparent-white-32)`
- `--s2a-color-control-button-background-transparent-hover: var(--s2a-color-transparent-white-16)`
- `--s2a-color-control-button-border-media: var(--s2a-color-transparent-white-24)`
- `--s2a-color-control-button-border-solid-active: var(--s2a-color-gray-700)`
- `--s2a-color-control-button-border-solid-default: var(--s2a-color-transparent-white-24)`
- `--s2a-color-control-button-border-solid-disabled: var(--s2a-color-transparent-black-08)`
- `--s2a-color-control-button-border-solid-focus: var(--s2a-color-transparent-black-08)`
- `--s2a-color-control-button-border-solid-hover: var(--s2a-color-gray-400)`
- `--s2a-color-control-button-border-transparent-disabled: var(--s2a-color-transparent-white-16)`
- `--s2a-color-divider-default: var(--s2a-color-gray-800)`
- `--s2a-color-divider-inverse: var(--s2a-color-gray-25)`
- `--s2a-color-divider-knockout: var(--s2a-color-gray-1000)`
- `--s2a-color-divider-strong: var(--s2a-color-gray-900)`
- `--s2a-color-divider-subtle: var(--s2a-color-transparent-black-12)`
- `--s2a-color-divider-subtle-inverse: var(--s2a-color-transparent-white-16)`
- `--s2a-color-icon-button-background-accent-solid-on-light-active: var(--s2a-color-blue-1100)`
- `--s2a-color-icon-button-background-accent-solid-on-light-default: var(--s2a-color-blue-900)`
- `--s2a-color-icon-button-background-accent-solid-on-light-hover: var(--s2a-color-blue-1000)`
- `--s2a-color-icon-button-background-knockout-active: var(--s2a-color-gray-100)`
- `--s2a-color-icon-button-background-knockout-default: var(--s2a-color-gray-25)`
- `--s2a-color-icon-button-background-knockout-hover: var(--s2a-color-gray-50)`
- `--s2a-color-icon-button-background-primary-outlined-on-dark-active: var(--s2a-color-gray-25)`
- `--s2a-color-icon-button-background-primary-outlined-on-dark-default: var(--s2a-color-transparent-white-00)`
- `--s2a-color-icon-button-background-primary-outlined-on-dark-hover: var(--s2a-color-transparent-white-64)`
- `--s2a-color-icon-button-background-primary-outlined-on-light-active: var(--s2a-color-gray-1000)`
- `--s2a-color-icon-button-background-primary-outlined-on-light-default: var(--s2a-color-transparent-black-00)`
- `--s2a-color-icon-button-background-primary-outlined-on-light-hover: var(--s2a-color-transparent-black-08)`
- `--s2a-color-icon-button-background-primary-solid-on-dark-active: var(--s2a-color-gray-25)`
- `--s2a-color-icon-button-background-primary-solid-on-dark-default: var(--s2a-color-gray-25)`
- `--s2a-color-icon-button-background-primary-solid-on-dark-hover: var(--s2a-color-transparent-white-64)`
- `--s2a-color-icon-button-background-primary-solid-on-light-active: var(--s2a-color-gray-1000)`
- `--s2a-color-icon-button-background-primary-solid-on-light-default: var(--s2a-color-gray-1000)`
- `--s2a-color-icon-button-background-primary-solid-on-light-hover: var(--s2a-color-transparent-black-64)`
- `--s2a-color-icon-button-background-primary-transparent-on-dark-active: var(--s2a-color-transparent-white-16)`
- `--s2a-color-icon-button-background-primary-transparent-on-dark-default: var(--s2a-color-transparent-white-00)`
- `--s2a-color-icon-button-background-primary-transparent-on-dark-hover: var(--s2a-color-transparent-white-12)`
- `--s2a-color-icon-button-background-primary-transparent-on-light-active: var(--s2a-color-transparent-black-12)`
- `--s2a-color-icon-button-background-primary-transparent-on-light-default: var(--s2a-color-transparent-black-00)`
- `--s2a-color-icon-button-background-primary-transparent-on-light-hover: var(--s2a-color-transparent-black-08)`
- `--s2a-color-icon-button-background-solid-active: var(--s2a-color-gray-1000)`
- `--s2a-color-icon-button-background-solid-default: var(--s2a-color-gray-1000)`
- `--s2a-color-icon-button-background-solid-hover: var(--s2a-color-transparent-black-64)`
- `--s2a-color-icon-button-background-transparent-active: var(--s2a-color-transparent-black-12)`
- `--s2a-color-icon-button-background-transparent-default: var(--s2a-color-transparent-black-00)`
- `--s2a-color-icon-button-background-transparent-hover: var(--s2a-color-transparent-black-08)`
- `--s2a-color-icon-button-border-primary-outlined-default: var(--s2a-color-gray-1000)`
- `--s2a-color-icon-button-border-primary-outlined-on-dark-default: var(--s2a-color-gray-25)`
- `--s2a-color-icon-button-border-primary-solid-on-dark-default: var(--s2a-color-gray-25)`
- `--s2a-color-icon-button-border-primary-solid-on-light-default: var(--s2a-color-gray-1000)`
- `--s2a-color-icon-button-content-knockout: var(--s2a-color-gray-1000)`
- `--s2a-color-icon-button-content-primary-outlined-default: var(--s2a-color-gray-1000)`
- `--s2a-color-icon-button-content-primary-outlined-knockout: var(--s2a-color-gray-25)`
- `--s2a-color-icon-button-content-primary-solid-default: var(--s2a-color-gray-25)`
- `--s2a-color-icon-button-content-primary-solid-inverse: var(--s2a-color-gray-1000)`
- `--s2a-color-icon-button-content-primary-transparent-default: var(--s2a-color-gray-1000)`
- `--s2a-color-icon-button-content-primary-transparent-knockout: var(--s2a-color-gray-25)`
- `--s2a-color-icon-button-content-solid: var(--s2a-color-gray-25)`
- `--s2a-color-icon-button-content-transparent: var(--s2a-color-gray-1000)`
- `--s2a-color-merch-card-highlight-features-background: var(--s2a-color-surface-inverse-subtle)`
- `--s2a-color-merch-card-highlight-features-content: var(--s2a-color-content-on-inverse)`
- `--s2a-color-merch-card-highlight-features-content-subtle: var(--s2a-color-content-on-inverse-subtle)`
- `--s2a-color-merch-card-pro-surface: var(--s2a-color-background-knockout)`
- `--s2a-color-page-default: var(--s2a-color-gray-25)`
- `--s2a-color-page-inverse: var(--s2a-color-gray-1000)`
- `--s2a-color-page-subtle: var(--s2a-color-gray-75)`
- `--s2a-color-promo-cta-background: var(--s2a-color-gray-1000)`
- `--s2a-color-promo-cta-button-background-active: var(--s2a-color-gray-1000)`
- `--s2a-color-promo-cta-button-background-default: var(--s2a-color-gray-800)`
- `--s2a-color-promo-cta-button-background-hover: var(--s2a-color-gray-700)`
- `--s2a-color-promo-cta-button-border-active: var(--s2a-color-transparent-white-24)`
- `--s2a-color-promo-cta-button-border-default: var(--s2a-color-gray-700)`
- `--s2a-color-promo-cta-button-border-hover: var(--s2a-color-gray-500)`
- `--s2a-color-promo-cta-button-icon-active: var(--s2a-color-gray-25)`
- `--s2a-color-promo-cta-label: var(--s2a-color-gray-25)`
- `--s2a-color-router-nav-item-background-active: var(--s2a-color-gray-25)`
- `--s2a-color-router-nav-item-content-active: var(--s2a-color-gray-1000)`
- `--s2a-color-section-default: var(--s2a-color-gray-25)`
- `--s2a-color-surface-default: var(--s2a-color-gray-25)`
- `--s2a-color-surface-inverse: var(--s2a-color-gray-1000)`
- `--s2a-color-surface-inverse-subtle: var(--s2a-color-gray-900)`
- `--s2a-color-surface-knockout: var(--s2a-color-gray-25)`
- `--s2a-color-surface-strong: #eee`
- `--s2a-color-surface-subtle: var(--s2a-color-gray-50)`
- `--s2a-segmented-control-segment-padding-x: var(--s2a-spacing-20)`
- `--s2a-segmented-control-track-radius: var(--s2a-border-radius-16)`

### 💥 Removed

- `--s2a-color-iconbutton-background-accent-solid-on-light-active` (was `var(--s2a-color-blue-1100)`)
- `--s2a-color-iconbutton-background-accent-solid-on-light-default` (was `var(--s2a-color-blue-900)`)
- `--s2a-color-iconbutton-background-accent-solid-on-light-hover` (was `var(--s2a-color-blue-1000)`)
- `--s2a-color-iconbutton-background-primary-outlined-on-dark-active` (was `var(--s2a-color-gray-25)`)
- `--s2a-color-iconbutton-background-primary-outlined-on-dark-default` (was `var(--s2a-color-transparent-white-00)`)
- `--s2a-color-iconbutton-background-primary-outlined-on-dark-hover` (was `var(--s2a-color-transparent-white-64)`)
- `--s2a-color-iconbutton-background-primary-outlined-on-light-active` (was `var(--s2a-color-gray-1000)`)
- `--s2a-color-iconbutton-background-primary-outlined-on-light-default` (was `var(--s2a-color-transparent-black-00)`)
- `--s2a-color-iconbutton-background-primary-outlined-on-light-hover` (was `var(--s2a-color-transparent-black-08)`)
- `--s2a-color-iconbutton-background-primary-solid-on-dark-active` (was `var(--s2a-color-gray-25)`)
- `--s2a-color-iconbutton-background-primary-solid-on-dark-default` (was `var(--s2a-color-gray-25)`)
- `--s2a-color-iconbutton-background-primary-solid-on-dark-hover` (was `var(--s2a-color-transparent-white-64)`)
- `--s2a-color-iconbutton-background-primary-solid-on-light-active` (was `var(--s2a-color-gray-1000)`)
- `--s2a-color-iconbutton-background-primary-solid-on-light-default` (was `var(--s2a-color-gray-1000)`)
- `--s2a-color-iconbutton-background-primary-solid-on-light-hover` (was `var(--s2a-color-transparent-black-64)`)
- `--s2a-color-iconbutton-background-primary-transparent-on-dark-active` (was `var(--s2a-color-transparent-white-16)`)
- `--s2a-color-iconbutton-background-primary-transparent-on-dark-default` (was `var(--s2a-color-transparent-white-00)`)
- `--s2a-color-iconbutton-background-primary-transparent-on-dark-hover` (was `var(--s2a-color-transparent-white-12)`)
- `--s2a-color-iconbutton-background-primary-transparent-on-light-active` (was `var(--s2a-color-transparent-black-12)`)
- `--s2a-color-iconbutton-background-primary-transparent-on-light-default` (was `var(--s2a-color-transparent-black-00)`)
- `--s2a-color-iconbutton-background-primary-transparent-on-light-hover` (was `var(--s2a-color-transparent-black-08)`)
- `--s2a-color-iconbutton-border-primary-outlined-default` (was `var(--s2a-color-gray-1000)`)
- `--s2a-color-iconbutton-border-primary-outlined-on-dark-default` (was `var(--s2a-color-gray-25)`)
- `--s2a-color-iconbutton-border-primary-solid-on-dark-default` (was `var(--s2a-color-gray-25)`)
- `--s2a-color-iconbutton-border-primary-solid-on-light-default` (was `var(--s2a-color-gray-1000)`)
- `--s2a-color-iconbutton-content-primary-outlined-default` (was `var(--s2a-color-gray-1000)`)
- `--s2a-color-iconbutton-content-primary-outlined-knockout` (was `var(--s2a-color-gray-25)`)
- `--s2a-color-iconbutton-content-primary-solid-default` (was `var(--s2a-color-gray-25)`)
- `--s2a-color-iconbutton-content-primary-solid-inverse` (was `var(--s2a-color-gray-1000)`)
- `--s2a-color-iconbutton-content-primary-transparent-default` (was `var(--s2a-color-gray-1000)`)
- `--s2a-color-iconbutton-content-primary-transparent-knockout` (was `var(--s2a-color-gray-25)`)

### ♻️ Changed

- `--s2a-color-content-inverse`: `var(--s2a-color-content-knockout)` → `var(--s2a-color-gray-1000)`
- `md` (tablet) responsive breakpoint media query: `@media (min-width: 1024px)` → `@media (width >= 768px)` — MWPW-206973. The tablet range starts at 768px, not 1024px, so `--s2a-section-spacing-*` and other `md`-tier tokens were flipping to their values too late. Also switches to the modern CSS range syntax, matching Milo's own convention (`context/milo/libs/c2/styles/styles.css`). `lg` (1280px) and `xl` (1441px) are unaffected, only the syntax form changed for those two.
