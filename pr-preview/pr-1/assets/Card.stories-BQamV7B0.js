import{E as C,x as a}from"./iframe-CV0psIaR.js";import{P as y,p as _}from"./progress-bar-DCTztfXd.js";import{A as S}from"./app-icon-CNUsW4ZO.js";import"./preload-helper-kk50mwSr.js";const o=({label:n="Card label",body:e,tone:t="knockout",orientation:k="horizontal",active:w=!1,showProgress:P=!1,progress:$=0,onClick:I}={})=>{const m=!!P,x=t==="default"?"default":"knockout";return a`
    <button
      class="c-card"
      data-tone=${x}
