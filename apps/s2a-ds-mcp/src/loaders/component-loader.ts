...
import type { ComponentEntry, PropDef } from "../types.js";
...
function loadSpec(srcDir: string, slug: string) {
...
export function loadComponents(dsRoot: string): ComponentEntry[] {
  const cached = dsCache.get<ComponentEntry[]>(CACHE_KEY);
